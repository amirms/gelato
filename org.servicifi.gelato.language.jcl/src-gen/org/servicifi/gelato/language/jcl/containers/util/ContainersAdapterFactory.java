...
public class ContainersAdapterFactory extends AdapterFactoryImpl {
	...
	protected ContainersSwitch<Adapter> modelSwitch =
		new ContainersSwitch<Adapter>() {
			@Override
			public Adapter caseJCLRoot(JCLRoot object) {
				return createJCLRootAdapter();
			}
			@Override
			public Adapter caseJobUnit(JobUnit object) {
				return createJobUnitAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.jcl.containers.JCLRoot <em>JCL Root</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createJCLRootAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.jcl.containers.JobUnit <em>Job Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createJobUnitAdapter() {
		return null;
	}
