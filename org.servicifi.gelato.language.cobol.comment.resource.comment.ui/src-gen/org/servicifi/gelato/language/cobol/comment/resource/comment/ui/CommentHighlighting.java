 ...
 */
public class CommentHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor editor;
	private ProjectionViewer projectionViewer;
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentOccurrence occurrence;
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBackgroundParsingListener {
	 ...
	 */
	public CommentHighlighting(org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentTextResource textResource, ProjectionViewer projectionViewer, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentColorManager colorManager, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentOccurrence(textResource, projectionViewer);
		this.bracketSet = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
