 ...
 */
public class CommentCompletionProposal implements Comparable<CommentCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentExpectedTerminal expectedTerminal;
	...
	public CommentCompletionProposal(org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public CommentCompletionProposal(org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public CommentCompletionProposal(org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof CommentCompletionProposal) {
			CommentCompletionProposal other = (CommentCompletionProposal) object;
	...
	public int compareTo(CommentCompletionProposal object) {
		if (object instanceof CommentCompletionProposal) {
			CommentCompletionProposal other = (CommentCompletionProposal) object;
