 ...
 * </p>
 */
public class CommentBracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentMetaInformation().getSyntaxName();
	
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public CommentBracketPreferencePage() {
		super();
		
		org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentMetaInformation metaInformation = new org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentMetaInformation();
	...
	public void init(IWorkbench workbench) {
		...
		bracketsTmp = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBracketSet();
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.deserialize(getPreferenceStore().getString(language + org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		enableCheckbox.setSelection(preferenceStore.getDefaultBoolean(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		matchingBracketsColorEditor.setColorValue(PreferenceConverter.getDefaultColor(preferenceStore, BRACKETS_COLOR));
		String defaultBrackets = preferenceStore.getDefaultString(language + org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	private void updateActiveEditor() {
		...
		preferenceStore.setValue(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		preferenceStore.setValue(language + org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		IWorkbench workbench = org.eclipse.ui.PlatformUI.getWorkbench();
		IEditorPart editor = workbench.getActiveWorkbenchWindow().getActivePage().getActiveEditor();
		if (editor != null && editor instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor) {
			((org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor) editor).invalidateTextRepresentation();
		}
	}
	
	protected org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair getSelectedBracketPair() {
