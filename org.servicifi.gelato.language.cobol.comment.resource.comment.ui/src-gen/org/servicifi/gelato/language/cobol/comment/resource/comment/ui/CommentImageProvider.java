 ...
 */
public class CommentImageProvider {
	
	public final static CommentImageProvider INSTANCE = new CommentImageProvider();
	...
	public ImageDescriptor getImageDescriptor(String key) {
		...
		if (ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
