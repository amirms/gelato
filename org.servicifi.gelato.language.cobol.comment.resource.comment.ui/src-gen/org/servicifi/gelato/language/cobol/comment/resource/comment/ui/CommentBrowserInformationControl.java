 ...
 * @since 3.2
 */
public class CommentBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput fInput;
	 ...
	 */
	public CommentBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public CommentBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public CommentBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput);
		...
		fInput= (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput) input;
		...
		org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput getInput() {
		return fInput;
	}
