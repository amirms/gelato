 ...
 */
public class CommentHyperlink implements IHyperlink {
	 ...
	 */
	public CommentHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
