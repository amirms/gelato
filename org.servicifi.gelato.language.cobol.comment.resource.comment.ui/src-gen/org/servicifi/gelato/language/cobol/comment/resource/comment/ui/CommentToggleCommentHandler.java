...
public class CommentToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor editor = null;
		
		if (editorPart instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor) {
			editor = (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor) editorPart;
