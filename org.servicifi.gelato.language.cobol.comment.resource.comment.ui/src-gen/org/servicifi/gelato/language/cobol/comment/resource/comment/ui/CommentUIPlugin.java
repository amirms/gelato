 ...
 */
public class CommentUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.servicifi.gelato.language.cobol.comment.resource.comment.ui";
	public static final String EDITOR_ID = "org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor";
	...
	private static CommentUIPlugin plugin;
	
	public CommentUIPlugin() {
		super();
	}
	...
	public static CommentUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, CommentUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, CommentUIPlugin.PLUGIN_ID, message);
		}
		final CommentUIPlugin pluginInstance = CommentUIPlugin.getDefault();
