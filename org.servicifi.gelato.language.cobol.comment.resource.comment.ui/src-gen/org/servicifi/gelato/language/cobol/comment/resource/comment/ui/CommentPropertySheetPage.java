...
public class CommentPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEObjectSelection) {
			final org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEObjectSelection selection = (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEObjectSelection) iSelection;
