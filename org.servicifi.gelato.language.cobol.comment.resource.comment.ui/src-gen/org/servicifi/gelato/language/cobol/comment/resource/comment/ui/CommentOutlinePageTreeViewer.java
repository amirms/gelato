 ...
 * a specified depth.
 */
public class CommentOutlinePageTreeViewer extends TreeViewer {
	...
	public CommentOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentPlugin.logError("Exception while refreshing outline view", e);
		}
	}
