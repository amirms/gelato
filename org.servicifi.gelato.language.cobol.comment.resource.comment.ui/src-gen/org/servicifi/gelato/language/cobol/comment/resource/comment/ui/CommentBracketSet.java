 ...
 */
public class CommentBracketSet {
	...
	private ArrayList<org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public CommentBracketSet() {
		super();
		...
		this.bracketPairs = new ArrayList<org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair>();
	}
	...
	public org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair getBracketPair(String opening, String closing) {
		for (org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair remove(String opening, String closing) {
		for (org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentBracketPair>();
	...
	public void highlightBrackets(IDocument document, int position, int caretOffset) {
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
