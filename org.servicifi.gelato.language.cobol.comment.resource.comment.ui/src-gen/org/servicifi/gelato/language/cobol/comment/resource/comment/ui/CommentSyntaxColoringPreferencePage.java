 ...
 * </p>
 */
public class CommentSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public CommentSyntaxColoringPreferencePage() {
		super();
		
		org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentMetaInformation metaInformation = new org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPixelConverter pixelConverter = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor) {
			org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor emfTextEditor = (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor) editor;
