 ...
 */
public class CommentOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.servicifi.gelato.language.cobol.comment.resource.comment.ui.outlinecontext";
	...
	public CommentOutlinePage(org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentOutlinePageTreeViewer) {
								org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentOutlinePageTreeViewer pageTreeViewer = (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentOutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.servicifi.gelato.language.cobol.comment.resource.comment.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentOutlinePageActionProvider().getActions(treeViewer);
