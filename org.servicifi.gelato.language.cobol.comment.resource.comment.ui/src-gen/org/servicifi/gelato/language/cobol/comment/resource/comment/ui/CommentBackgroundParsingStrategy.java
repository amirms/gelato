 ...
 */
public class CommentBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentTextResource resource, final org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentTextResource resource, final org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentTextResource resource, final org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentResource) {
							org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentResource concreteResource = (org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentResource) resource;
