 ...
 * olInput</code>.
 */
public class CommentDocBrowserInformationControlInput {
	
	private final CommentDocBrowserInformationControlInput fPrevious;
	private CommentDocBrowserInformationControlInput fNext;
	 ...
	 */
	public CommentDocBrowserInformationControlInput(CommentDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public CommentDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public CommentDocBrowserInformationControlInput getNext() {
		return fNext;
	}
