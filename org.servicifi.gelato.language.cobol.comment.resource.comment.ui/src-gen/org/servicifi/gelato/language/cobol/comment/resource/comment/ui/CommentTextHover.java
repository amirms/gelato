 ...
 */
public class CommentTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput infoInput = (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHyperlink hyperlink = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			if (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBrowserInformationControl.isAvailable(parent)) {
				ToolBarManager tbm = new ToolBarManager(SWT.FLAT);
				org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBrowserInformationControl iControl = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBrowserInformationControl(parent, FONT, tbm);
				...
				IInputChangedListener inputChangeListener = new IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput) {
							org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput input = (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			...
			if (org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBrowserInformationControl.isAvailable(parent)) {
				org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBrowserInformationControl iControl = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public CommentTextHover(org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHTMLPrinter.insertPageProlog(buffer, 0, org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentTextHover.getStyleSheet());
			org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHTMLPrinter.addPageEpilog(buffer);
			return new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.servicifi.gelato.language.cobol.comment.resource.comment.util.CommentStreamUtil.getContent(styleSheetURL.openStream());
