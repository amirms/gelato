...
public class CommentOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			org.servicifi.gelato.language.cobol.comment.resource.comment.ICommentNameProvider nameProvider = new org.servicifi.gelato.language.cobol.comment.resource.comment.mopp.CommentMetaInformation().createNameProvider();
