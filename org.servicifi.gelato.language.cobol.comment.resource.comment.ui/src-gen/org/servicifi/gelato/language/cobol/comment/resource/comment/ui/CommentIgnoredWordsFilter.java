 ...
 */
public class CommentIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.servicifi.gelato.language.cobol.comment.resource.comment.grammar.CommentGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
