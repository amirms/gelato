...
/**
 * The CommentAutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class CommentAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBracketSet bracketSet;
	
	public CommentAutoEditStrategy() {
		super();
		org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentUIPlugin plugin = org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentUIPlugin.getDefault();
		if (plugin != null) {
			IPreferenceStore preferenceStore = plugin.getPreferenceStore();
			bracketSet = new org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.servicifi.gelato.language.cobol.comment.resource.comment.ui.CommentBracketSet bracketSet) {
