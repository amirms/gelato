 ...
 * hovers, is a proxy.
 */
public class JclHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public JclHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
