 ...
 */
public class JclIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
