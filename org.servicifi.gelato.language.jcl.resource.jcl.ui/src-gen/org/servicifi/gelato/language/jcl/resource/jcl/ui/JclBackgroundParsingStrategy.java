 ...
 */
public class JclBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource resource, final org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource resource, final org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource resource, final org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclResource) {
							org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclResource concreteResource = (org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclResource) resource;
