 ...
 */
public class JclHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public JclHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
