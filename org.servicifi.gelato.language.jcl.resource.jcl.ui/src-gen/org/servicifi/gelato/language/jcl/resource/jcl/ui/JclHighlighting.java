 ...
 */
public class JclHighlighting implements ISelectionProvider, ISelectionChangedListener {
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.servicifi.gelato.language.jcl.resource.jcl.IJclBackgroundParsingListener {
	 ...
	 */
	public JclHighlighting(org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource textResource, ProjectionViewer projectionViewer, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclColorManager colorManager, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOccurrence(textResource, projectionViewer);
		this.bracketSet = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionCategory.BRACKET.toString());
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		...
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
