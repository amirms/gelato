 ...
 */
public class JclCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.servicifi.gelato.language.jcl.resource.jcl.IJclBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor) {
				org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor = (org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor) workbenchPart;
	...
	protected org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor;
	 ...
	 */
	public JclCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor textEditor) {
	...
	private void addCloseListener(final org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource textResource = (org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
