 ...
 */
public class JclUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.servicifi.gelato.language.jcl.resource.jcl.ui";
	public static final String EDITOR_ID = "org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor";
	...
	private static JclUIPlugin plugin;
	...
	public static JclUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, JclUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, JclUIPlugin.PLUGIN_ID, message);
		}
		final JclUIPlugin pluginInstance = JclUIPlugin.getDefault();
