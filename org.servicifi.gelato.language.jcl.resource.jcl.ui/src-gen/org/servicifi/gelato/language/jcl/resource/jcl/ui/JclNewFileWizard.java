...
public class JclNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.servicifi.gelato.language.jcl.resource.jcl.ui.JclNewFileWizardPage page;
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
