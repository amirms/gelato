 ...
 * @since 3.2
 */
public class JclBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	 ...
	 */
	public JclBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public JclBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public JclBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
