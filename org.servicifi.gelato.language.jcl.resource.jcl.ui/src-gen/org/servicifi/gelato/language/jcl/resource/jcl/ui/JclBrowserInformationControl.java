 ...
 * @since 3.2
 */
public class JclBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput fInput;
	 ...
	 */
	public JclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public JclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public JclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput);
		...
		fInput= (org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput) input;
		...
		org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput getInput() {
		return fInput;
	}
