 ...
 * olInput</code>.
 */
public class JclDocBrowserInformationControlInput {
	
	private final JclDocBrowserInformationControlInput fPrevious;
	private JclDocBrowserInformationControlInput fNext;
	 ...
	 */
	public JclDocBrowserInformationControlInput(JclDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public JclDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public JclDocBrowserInformationControlInput getNext() {
		return fNext;
	}
