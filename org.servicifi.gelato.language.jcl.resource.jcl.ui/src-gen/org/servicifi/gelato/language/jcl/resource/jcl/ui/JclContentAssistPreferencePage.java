 ...
 */
public class JclContentAssistPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public JclContentAssistPreferencePage() {
		initialize();
	}
	...
	public void init(IWorkbench workbench) {
		...
		// init values
		assistEnabled = preferenceStore.getBoolean(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getInt(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getString(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
	}
	...
	protected void performDefaults() {
		IPreferenceStore preferenceStore = getPreferenceStore();
		assistEnabled = preferenceStore.getDefaultBoolean(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getDefaultInt(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getDefaultString(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
		// defaults in widgets
	...
	private boolean updatePreferences() {
		...
		try {
			...
			org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclPlugin.getDefault().getLog().log(			new Status(IStatus.ERROR			, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIPlugin.getDefault().getBundle().getSymbolicName()			, "Value '" + delayText + "' is no valid delay value"			, exception)			);
			return false;
		}
		activationTriggers = txtTriggers.getText();
		IPreferenceStore preferenceStore = getPreferenceStore();
		preferenceStore.setValue(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED, assistEnabled);
		preferenceStore.setValue(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY, activationDelay);
		preferenceStore.setValue(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS, activationTriggers);
		return true;
	}
