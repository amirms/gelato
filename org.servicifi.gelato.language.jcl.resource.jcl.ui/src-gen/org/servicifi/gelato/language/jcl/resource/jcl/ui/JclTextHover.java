 ...
 */
public class JclTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.servicifi.gelato.language.jcl.resource.jcl.IJclHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput infoInput = (org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHyperlink hyperlink = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBrowserInformationControl iControl = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput) {
							org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput input = (org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBrowserInformationControl.isAvailable(parent)) {
				org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBrowserInformationControl iControl = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public JclTextHover(org.servicifi.gelato.language.jcl.resource.jcl.IJclResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHTMLPrinter.insertPageProlog(buffer, 0, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclTextHover.getStyleSheet());
			org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHTMLPrinter.addPageEpilog(buffer);
			return new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.servicifi.gelato.language.jcl.resource.jcl.ui.JclHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.servicifi.gelato.language.jcl.resource.jcl.util.JclStreamUtil.getContent(styleSheetURL.openStream());
