 ...
 */
public class JclNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.servicifi.gelato.language.jcl.resource.jcl.ui");
							...
							String natureID = org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclNature.NATURE_ID;
							...
							for (String builderID : org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclMetaInformation info = new org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIPlugin.getDefault().getBundle();
