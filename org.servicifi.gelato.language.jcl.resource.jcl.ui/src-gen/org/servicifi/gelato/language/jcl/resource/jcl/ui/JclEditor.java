...
public class JclEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.servicifi.gelato.language.jcl.resource.jcl.IJclResourceProvider, org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclBracketHandlerProvider, org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclAnnotationModelProvider {
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.servicifi.gelato.language.jcl.resource.jcl.EditorContext");
		setRulerContextMenuId("org.servicifi.gelato.language.jcl.resource.jcl.EditorRuler");
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource) {
				...
				org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource resource) {
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.servicifi.gelato.language.jcl.resource.jcl.IJclTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.servicifi.gelato.language.jcl.resource.jcl.IJclTextToken token = lexer.getNextToken();
			...
			org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.servicifi.gelato.language.jcl.resource.jcl.IJclBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.servicifi.gelato.language.jcl.resource.jcl.IJclBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource)) {
					return false;
				}
				org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource textResource = (org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource) resource;
				org.servicifi.gelato.language.jcl.resource.jcl.IJclLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
