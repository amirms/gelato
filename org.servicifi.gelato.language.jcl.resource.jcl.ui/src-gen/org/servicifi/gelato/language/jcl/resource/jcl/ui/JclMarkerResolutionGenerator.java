...
public class JclMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
		...
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				if (emfResource instanceof org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclResource) {
					...
					java.util.Collection<org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix> quickFixes = getQuickFixes(customResource, marker);
	...
	public java.util.Collection<org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix> getQuickFixes(org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource resource, org.eclipse.core.resources.IMarker marker) {
