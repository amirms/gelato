...
public class JclQuickAssistProcessor implements IQuickAssistProcessor {
	...
	public boolean canFix(Annotation annotation) {
		Collection<org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix> quickFixes = getQuickFixes(annotation);
	...
	public ICompletionProposal[] computeQuickAssistProposals(IQuickAssistInvocationContext invocationContext) {
		...
		List<org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix> quickFixes = getQuickFixes(sourceViewer, offset, length);
	...
	private ICompletionProposal createCompletionProposal(final ISourceViewer sourceViewer, final org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix quickFix) {
	...
	private List<org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix> getQuickFixes(ISourceViewer sourceViewer, int offset, int length) {
		List<org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix> foundFixes = new ArrayList<org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix>();
	...
	private Collection<org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix> getQuickFixes(Annotation annotation) {
