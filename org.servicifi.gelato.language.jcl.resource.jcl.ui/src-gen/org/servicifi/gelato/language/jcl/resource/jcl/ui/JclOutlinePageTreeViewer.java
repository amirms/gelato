 ...
 * a specified depth.
 */
public class JclOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public JclOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.servicifi.gelato.language.jcl.resource.jcl.util.JclStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclPlugin.logError("Exception while refreshing outline view", e);
		}
	}
