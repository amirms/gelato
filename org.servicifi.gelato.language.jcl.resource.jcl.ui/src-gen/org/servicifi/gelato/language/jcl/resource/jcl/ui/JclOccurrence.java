 ...
 */
public class JclOccurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclTokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.servicifi.gelato.language.jcl.resource.jcl.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.servicifi.gelato.language.jcl.resource.jcl.ui.occurences.declaration";
	
	private final static org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionHelper positionHelper = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionHelper();
	 ...
	 */
	private org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource textResource;
	...
	/**
	 * <p>
	 * Creates a JclOccurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public JclOccurrence(org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(org.servicifi.gelato.language.jcl.resource.jcl.IJclLocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclTokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected void addAnnotationsForReferences(EObject referencedElement, List<String> matchingNames) {
		...
		for (Setting setting : referencingObjects) {
			...
			for (String name : matchingNames) {
				...
				if (index > 0) {
					addAnnotation(document, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionCategory.PROXY, name, index, name.length());
				}
			}
		}
	}
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new org.servicifi.gelato.language.jcl.resource.jcl.analysis.JclDefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclTokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclTokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclTokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		org.servicifi.gelato.language.jcl.resource.jcl.IJclLocationMap locationMap = textResource.getLocationMap();
		
		org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclTokenScanner tokenScanner = createTokenScanner();
	...
	protected org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclTokenScanner createTokenScanner() {
		return new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclUIMetaInformation().createTokenScanner(null, null);
	}
	
	protected void addAnnotation(IDocument document, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionCategory type, String text, int offset, int length) {
		...
		if (type == org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionCategory.DEFINITION) {
	...
	protected void removeAnnotations() {
		removeAnnotations(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOccurrence.DECLARATION_ANNOTATION_ID);
	}
