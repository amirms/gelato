...
/**
 * The JclAutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class JclAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBracketSet bracketSet;
	
	public JclAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclBracketSet bracketSet) {
