 ...
 */
public class JclOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.servicifi.gelato.language.jcl.resource.jcl.ui.outlinecontext";
	...
	public JclOutlinePage(org.servicifi.gelato.language.jcl.resource.jcl.IJclResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOutlinePageTreeViewer) {
								org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOutlinePageTreeViewer pageTreeViewer = (org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.servicifi.gelato.language.jcl.resource.jcl.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.servicifi.gelato.language.jcl.resource.jcl.ui.JclOutlinePageActionProvider().getActions(treeViewer);
