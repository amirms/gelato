...
public class JclBracketSet {
	...
	private ArrayList<org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public JclBracketSet() {
		super();
		this.languageID = new org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclMetaInformation().getSyntaxName();
		this.bracketPairs = new ArrayList<org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair>();
	}
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair>();
