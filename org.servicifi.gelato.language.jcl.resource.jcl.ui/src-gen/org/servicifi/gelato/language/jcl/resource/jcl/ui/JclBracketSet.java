...
public class JclBracketSet {
	...
	private java.util.ArrayList<org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair {
	 ...
	 */
	private class ClosingListener implements org.servicifi.gelato.language.jcl.resource.jcl.ui.IJclBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public JclBracketSet(org.servicifi.gelato.language.jcl.resource.jcl.ui.JclEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair>();
	 ...
	 */
	public org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair getBracketPair(String opening, String closing) {
		for (org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair bracketPair : bracketPairs) {
	...
	public org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair remove(String opening, String closing) {
		for (org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.servicifi.gelato.language.jcl.resource.jcl.ui.JclPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
