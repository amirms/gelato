 ...
 */
public class JclCompletionProposal implements Comparable<JclCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclExpectedTerminal expectedTerminal;
	...
	public JclCompletionProposal(org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public JclCompletionProposal(org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public JclCompletionProposal(org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof JclCompletionProposal) {
			JclCompletionProposal other = (JclCompletionProposal) object;
	...
	public int compareTo(JclCompletionProposal object) {
		if (object instanceof JclCompletionProposal) {
			JclCompletionProposal other = (JclCompletionProposal) object;
