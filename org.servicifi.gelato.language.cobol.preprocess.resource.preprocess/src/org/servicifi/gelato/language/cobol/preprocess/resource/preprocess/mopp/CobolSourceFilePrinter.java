...
import org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessProblem;
import org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextDiagnostic;
import org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextResource;
import org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.PreprocessEProblemType;
import org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.grammar.PreprocessFormattingElement;
import org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessPrinter2;
...
import org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.util.*;
import org.servicifi.gelato.diagram.DataDependency;
...
public class CobolSourceFilePrinter extends PreprocessPrinter2 {
	...
	public CobolSourceFilePrinter(OutputStream outputStream,
			IPreprocessTextResource resource) {
	...
	protected void doPrint(EObject element, List<PreprocessFormattingElement> foundFormattingElements) 
	{
		...
		try{
			...
			{	
				...
				createDataDependency(element.eResource().getURI(), cobolPreprocessClasspath.getCobolCopybook(cpysen.getName()));
				
				//URI uri = cobolPreprocessClasspath.getCobolCopybook(cpysen.getName());		
				String cpycontents = "";
				try{
					BufferedReader br = new BufferedReader(new FileReader(
						"C:\\Users\\Administrator\\Desktop\\QVT\\workspace\\org.servicifi.gelato.language.cobol.preprocessor\\preprocessed2\\copybook\\" + cpysen.getName() + ".cpy"));
		...
		private String processCopybook(String cpytext,
				EList<Replacing> replacings) throws IOException {
