...
public class CopySentenceTargetReferenceResolver implements
		org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessReferenceResolver<org.servicifi.gelato.language.cobol.preprocess.sentences.CopySentence, org.servicifi.gelato.language.cobol.preprocess.containers.Copybook> {
	...
	public void resolve(String identifier,
			org.servicifi.gelato.language.cobol.preprocess.sentences.CopySentence container,
			org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy,
			final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessReferenceResolveResult<org.servicifi.gelato.language.cobol.preprocess.containers.Copybook> result) {
		EObject target = null;
		Copybook proxy = null;
		proxy = (Copybook) CobolPreprocessClasspath.get().getCopybook(identifier);

		target = (Copybook) EcoreUtil.resolve(proxy, container.eResource());
	...
	public String deResolve(org.servicifi.gelato.language.cobol.preprocess.containers.Copybook element,
			org.servicifi.gelato.language.cobol.preprocess.sentences.CopySentence container,
