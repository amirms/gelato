 ...
 */
public class CobolHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public CobolHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
