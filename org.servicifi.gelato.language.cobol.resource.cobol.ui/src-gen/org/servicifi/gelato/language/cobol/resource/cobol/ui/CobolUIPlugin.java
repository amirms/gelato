 ...
 */
public class CobolUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.servicifi.gelato.language.cobol.resource.cobol.ui";
	public static final String EDITOR_ID = "org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor";
	...
	private static CobolUIPlugin plugin;
	
	public CobolUIPlugin() {
		super();
	}
	...
	public static CobolUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CobolUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CobolUIPlugin.PLUGIN_ID, message);
		}
		final CobolUIPlugin pluginInstance = CobolUIPlugin.getDefault();
