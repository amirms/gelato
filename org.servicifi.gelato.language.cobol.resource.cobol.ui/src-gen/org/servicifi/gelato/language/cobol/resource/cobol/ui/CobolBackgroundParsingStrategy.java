 ...
 */
public class CobolBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource resource, final org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource resource, final org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource resource, final org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolResource) {
							org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolResource concreteResource = (org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolResource) resource;
