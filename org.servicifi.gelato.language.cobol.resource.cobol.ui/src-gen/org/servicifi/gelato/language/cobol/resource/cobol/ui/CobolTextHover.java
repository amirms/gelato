 ...
 */
public class CobolTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.servicifi.gelato.language.cobol.resource.cobol.ICobolHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput infoInput = (org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolHyperlink hyperlink = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBrowserInformationControl iControl = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput) {
							org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput input = (org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBrowserInformationControl.isAvailable(parent)) {
				org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBrowserInformationControl iControl = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public CobolTextHover(org.servicifi.gelato.language.cobol.resource.cobol.ICobolResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolHTMLPrinter.insertPageProlog(buffer, 0, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolTextHover.getStyleSheet());
			org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolHTMLPrinter.addPageEpilog(buffer);
			return new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.servicifi.gelato.language.cobol.resource.cobol.util.CobolStreamUtil.getContent(styleSheetURL.openStream());
