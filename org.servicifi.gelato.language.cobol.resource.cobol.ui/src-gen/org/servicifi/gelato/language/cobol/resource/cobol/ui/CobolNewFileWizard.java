...
public class CobolNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolNewFileWizardPage page;
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
