 ...
 */
public class CobolOccurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolTokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.servicifi.gelato.language.cobol.resource.cobol.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.servicifi.gelato.language.cobol.resource.cobol.ui.occurences.declaration";
	
	private final static org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionHelper positionHelper = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionHelper();
	 ...
	 */
	private org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource textResource;
	...
	/**
	 * <p>
	 * Creates a CobolOccurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public CobolOccurrence(org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(org.servicifi.gelato.language.cobol.resource.cobol.ICobolLocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolTokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected void addAnnotationsForReferences(EObject referencedElement, List<String> matchingNames) {
		...
		for (Setting setting : referencingObjects) {
			...
			for (String name : matchingNames) {
				...
				if (index > 0) {
					addAnnotation(document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.PROXY, name, index, name.length());
				}
			}
		}
	}
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new org.servicifi.gelato.language.cobol.resource.cobol.analysis.CobolDefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolTokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolTokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolTokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		org.servicifi.gelato.language.cobol.resource.cobol.ICobolLocationMap locationMap = textResource.getLocationMap();
		
		org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolTokenScanner tokenScanner = createTokenScanner();
	...
	protected org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolTokenScanner createTokenScanner() {
		return new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIMetaInformation().createTokenScanner(null, null);
	}
	
	protected void addAnnotation(IDocument document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory type, String text, int offset, int length) {
		...
		if (type == org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.DEFINITION) {
	...
	protected void removeAnnotations() {
		removeAnnotations(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOccurrence.DECLARATION_ANNOTATION_ID);
	}
