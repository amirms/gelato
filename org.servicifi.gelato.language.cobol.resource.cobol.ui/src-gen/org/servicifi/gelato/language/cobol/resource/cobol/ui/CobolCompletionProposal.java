 ...
 */
public class CobolCompletionProposal implements Comparable<CobolCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal;
	...
	public CobolCompletionProposal(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public CobolCompletionProposal(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public CobolCompletionProposal(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof CobolCompletionProposal) {
			CobolCompletionProposal other = (CobolCompletionProposal) object;
	...
	public int compareTo(CobolCompletionProposal object) {
		if (object instanceof CobolCompletionProposal) {
			CobolCompletionProposal other = (CobolCompletionProposal) object;
