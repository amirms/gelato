 ...
 * hovers, is a proxy.
 */
public class CobolHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public CobolHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
