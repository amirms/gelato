 ...
 */
public class CobolOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.servicifi.gelato.language.cobol.resource.cobol.ui.outlinecontext";
	...
	public CobolOutlinePage(org.servicifi.gelato.language.cobol.resource.cobol.ICobolResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOutlinePageTreeViewer) {
								org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOutlinePageTreeViewer pageTreeViewer = (org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.servicifi.gelato.language.cobol.resource.cobol.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOutlinePageActionProvider().getActions(treeViewer);
