 ...
 */
public class CobolCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.servicifi.gelato.language.cobol.resource.cobol.ICobolBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor) {
				org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor = (org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor) workbenchPart;
	...
	protected org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor;
	 ...
	 */
	public CobolCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor textEditor) {
	...
	private void addCloseListener(final org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource textResource = (org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
