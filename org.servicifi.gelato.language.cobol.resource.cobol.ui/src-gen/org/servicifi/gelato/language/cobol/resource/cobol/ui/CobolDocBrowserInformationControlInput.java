 ...
 * olInput</code>.
 */
public class CobolDocBrowserInformationControlInput {
	
	private final CobolDocBrowserInformationControlInput fPrevious;
	private CobolDocBrowserInformationControlInput fNext;
	 ...
	 */
	public CobolDocBrowserInformationControlInput(CobolDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public CobolDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public CobolDocBrowserInformationControlInput getNext() {
		return fNext;
	}
