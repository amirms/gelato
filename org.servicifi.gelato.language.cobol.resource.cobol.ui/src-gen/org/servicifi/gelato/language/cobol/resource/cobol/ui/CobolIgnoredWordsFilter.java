 ...
 */
public class CobolIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
