 ...
 * a specified depth.
 */
public class CobolOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public CobolOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.servicifi.gelato.language.cobol.resource.cobol.util.CobolStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolPlugin.logError("Exception while refreshing outline view", e);
		}
	}
