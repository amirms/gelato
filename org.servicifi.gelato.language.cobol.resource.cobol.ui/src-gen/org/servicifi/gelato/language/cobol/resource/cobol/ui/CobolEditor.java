 ...
 * </p>
 */
public class CobolEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.servicifi.gelato.language.cobol.resource.cobol.ICobolResourceProvider, org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolBracketHandlerProvider, org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolAnnotationModelProvider {
	...
	private java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ICobolBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ICobolBackgroundParsingListener>();
	...
	public CobolEditor() {
		super();
		setSourceViewerConfiguration(new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolSourceViewerConfiguration(this, this, this, colorManager));
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource) {
					...
					org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the CobolEditor.");
