 ...
 */
public class CobolHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolTokenScanner scanner;
	...
	private org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOccurrence occurrence;
	private org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.servicifi.gelato.language.cobol.resource.cobol.ICobolBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public CobolHighlighting(org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolColorManager colorManager, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolTokenScanner(textResource, colorManager);
		occurrence = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
