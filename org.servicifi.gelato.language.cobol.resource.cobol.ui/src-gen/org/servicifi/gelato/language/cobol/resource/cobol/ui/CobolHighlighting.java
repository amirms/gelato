 ...
 */
public class CobolHighlighting implements ISelectionProvider, ISelectionChangedListener {
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.servicifi.gelato.language.cobol.resource.cobol.ICobolBackgroundParsingListener {
	 ...
	 */
	public CobolHighlighting(org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource textResource, ProjectionViewer projectionViewer, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolColorManager colorManager, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolOccurrence(textResource, projectionViewer);
		this.bracketSet = new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.BRACKET.toString());
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		...
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
