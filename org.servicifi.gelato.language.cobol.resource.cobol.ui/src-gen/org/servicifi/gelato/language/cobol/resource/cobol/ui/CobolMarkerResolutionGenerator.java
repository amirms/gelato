...
public class CobolMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.servicifi.gelato.language.cobol.resource.cobol.ICobolOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolResource) {
					org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolResource customResource = (org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ICobolQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.servicifi.gelato.language.cobol.resource.cobol.ICobolQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ICobolQuickFix> getQuickFixes(org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.servicifi.gelato.language.cobol.resource.cobol.ICobolQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
