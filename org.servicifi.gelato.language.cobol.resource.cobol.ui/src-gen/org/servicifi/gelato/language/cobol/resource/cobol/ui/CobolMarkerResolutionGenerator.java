...
public class CobolMarkerResolutionGenerator implements IMarkerResolutionGenerator {
		...
		try {
			...
			if (resource instanceof IFile) {
				...
				if (emfResource instanceof org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolResource) {
					...
					Collection<org.servicifi.gelato.language.cobol.resource.cobol.ICobolQuickFix> quickFixes = getQuickFixes(customResource, marker);
	...
	public Collection<org.servicifi.gelato.language.cobol.resource.cobol.ICobolQuickFix> getQuickFixes(org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource resource, IMarker marker) {
