 ...
 */
public class CobolNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public CobolNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new cobol file");
