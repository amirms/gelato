...
public class CobolCodeCompletionHelper {
	...
	public org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal[] computeCompletionProposals(org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource originalResource, String content, int cursorOffset) {
		...
		java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedAfterCursor = java.util.Arrays.asList(getElementsExpectedAt(expectedElements, cursorOffset));
		java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedBeforeCursor = java.util.Arrays.asList(getElementsExpectedAt(expectedElements, cursorOffset - 1));
		...
		java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> allProposals = new java.util.LinkedHashSet<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>();
		java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> rightProposals = deriveProposals(expectedAfterCursor, content, resource, cursorOffset);
		java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> leftProposals = deriveProposals(expectedBeforeCursor, content, resource, cursorOffset - 1);
		...
		final java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> sortedProposals = new java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>(allProposals);
	...
	public org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal[] parseToExpectedElements(org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextParser parser, org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource resource, int cursorOffset) {
		final java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedElements = parser.parseToExpectedElements(null, resource, cursorOffset);
		if (expectedElements == null) {
	 ...
	 * the same position.
	 */
	protected void removeDuplicateEntries(java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedElements) {
		...
		java.util.Map<Integer, java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal>> map = new java.util.LinkedHashMap<Integer, java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal>>();
		for (int i = 0; i < size; i++) {
			...
			java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> list = map.get(start1);
			if (list == null) {
				list = new java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal>();
				map.put(start1, list);
			}
		...
		for (int position : map.keySet()) {
			java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> list = map.get(position);
	 ...
	 */
	protected void removeDuplicateEntriesFromBucket(java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedElements) {
		int size = expectedElements.size();
	...
	protected void removeInvalidEntriesAtEnd(java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedElements) {
		for (int i = 0; i < expectedElements.size() - 1;) {
			org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal elementAtIndex = expectedElements.get(i);
			org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal elementAtNext = expectedElements.get(i + 1);
			...
			// rule.
			org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolSyntaxElement symtaxElementOfThis = elementAtIndex.getTerminal().getSymtaxElement();
			org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolSyntaxElement symtaxElementOfNext = elementAtNext.getTerminal().getSymtaxElement();
	 ...
	 */
	protected void removeKeywordsEndingBeforeIndex(java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> proposals, int index) {
		java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> toRemove = new java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>();
	...
	protected String findPrefix(java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedElements, org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedAtCursor, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return "";
		}
		int end = 0;
	...
	protected java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> deriveProposals(java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedElements, String content, org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource resource, int cursorOffset) {
		java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> resultSet = new java.util.LinkedHashSet<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>();
		for (org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedElement : expectedElements) {
	...
	protected java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> deriveProposals(final org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, String content, org.servicifi.gelato.language.cobol.resource.cobol.ICobolTextResource resource, int cursorOffset) {
		...
		if (expectedElement instanceof org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedCsString) {
			...
			// completed.
			final java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> proposals = new java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>();
	...
	protected java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> handleNCReference(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, String prefix, String tokenName) {
		...
		org.servicifi.gelato.language.cobol.resource.cobol.ICobolTokenResolverFactory tokenResolverFactory = metaInformation.getTokenResolverFactory();
		org.servicifi.gelato.language.cobol.resource.cobol.ICobolReferenceResolveResult<org.eclipse.emf.ecore.EObject> result = new org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolReferenceResolveResult<org.eclipse.emf.ecore.EObject>(true);
		resolverSwitch.resolveFuzzy(prefix, container, reference, 0, result);
		java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ICobolReferenceMapping<org.eclipse.emf.ecore.EObject>> mappings = result.getMappings();
		if (mappings != null) {
			java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> resultSet = new java.util.LinkedHashSet<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>();
			for (org.servicifi.gelato.language.cobol.resource.cobol.ICobolReferenceMapping<org.eclipse.emf.ecore.EObject> mapping : mappings) {
				...
				if (mapping instanceof org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolElementMapping<?>) {
					...
					resultSet.add(new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal(expectedTerminal, identifier, prefix, matchesPrefix, reference, container, image));
				}
			}
			return resultSet;
		}
	...
	protected java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> handleAttribute(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EAttribute attribute, String prefix) {
		java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> resultSet = new java.util.LinkedHashSet<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>();
	 ...
	 */
	protected java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> handleKeyword(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedCsString csString, String prefix) {
		String proposal = csString.getValue();
		boolean matchesPrefix = matches(proposal, prefix);
		return java.util.Collections.singleton(new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal(expectedTerminal, proposal, prefix, matchesPrefix, null, null));
	}
	
	/**
	 * Creates a set of (two) completion proposals from the given boolean terminal.
	 */
	protected java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> handleBooleanTerminal(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedBooleanTerminal expectedBooleanTerminal, String prefix) {
		java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> result = new java.util.LinkedHashSet<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>(2);
	 ...
	 */
	protected java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> handleEnumerationTerminal(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedEnumerationTerminal expectedEnumerationTerminal, String prefix) {
		java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> result = new java.util.LinkedHashSet<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal>(2);
	...
	protected java.util.Collection<org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal> handleLiteral(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EAttribute attribute, String prefix, String literal) {
		if ("".equals(literal)) {
			return java.util.Collections.emptySet();
		}
		boolean matchesPrefix = matches(literal, prefix);
		return java.util.Collections.singleton(new org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolCompletionProposal(expectedTerminal, literal, prefix, matchesPrefix, null, null));
	}
	 ...
	 * element is expected.
	 */
	protected void setPrefixes(java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedElements, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return;
		}
		for (org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedElement : expectedElements) {
	...
	public org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal[] getElementsExpectedAt(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal[] allExpectedElements, int cursorOffset) {
		java.util.List<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal> expectedAtCursor = new java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal>();
	...
	protected org.eclipse.emf.ecore.EObject findCorrectContainer(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolExpectedTerminal expectedTerminal) {
	 ...
	 */
	protected org.eclipse.emf.ecore.EObject findHookParent(org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EClass startClass, org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolContainedFeature currentLink, org.eclipse.emf.ecore.EObject object) {
		org.eclipse.emf.ecore.EClass containerClass = currentLink.getContainerClass();
