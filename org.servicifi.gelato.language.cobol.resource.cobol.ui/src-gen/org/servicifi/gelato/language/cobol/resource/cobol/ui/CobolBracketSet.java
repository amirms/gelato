...
public class CobolBracketSet {
	...
	private java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair {
	 ...
	 */
	private class ClosingListener implements org.servicifi.gelato.language.cobol.resource.cobol.ui.ICobolBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public CobolBracketSet(org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair>();
	 ...
	 */
	public org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair getBracketPair(String opening, String closing) {
		for (org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair bracketPair : bracketPairs) {
	...
	public org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair remove(String opening, String closing) {
		for (org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.servicifi.gelato.language.cobol.resource.cobol.ui.CobolPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
