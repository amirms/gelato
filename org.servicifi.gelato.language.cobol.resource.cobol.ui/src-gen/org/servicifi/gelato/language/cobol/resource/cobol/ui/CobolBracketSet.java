...
public class CobolBracketSet {
	...
	private ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public CobolBracketSet() {
		super();
		this.languageID = new org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolMetaInformation().getSyntaxName();
		this.bracketPairs = new ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair>();
	}
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair>();
