/**
 */
package org.servicifi.gelato.language.kernel.containers.util;
 ...
 * <!-- end-user-doc -->
 * @see org.servicifi.gelato.language.kernel.containers.ContainersPackage
 * @generated
 */
public class ContainersAdapterFactory extends AdapterFactoryImpl {
	...
	protected ContainersSwitch<Adapter> modelSwitch =
		new ContainersSwitch<Adapter>() {
			@Override
			public Adapter caseKernelRoot(KernelRoot object) {
				return createKernelRootAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.kernel.containers.KernelRoot <em>Kernel Root</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createKernelRootAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.kernel.containers.CompilationUnit <em>Compilation Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
