 ...
 * <ul>
 *   <li>{@link org.servicifi.gelato.language.kernel.procedures.impl.MainProcedureImpl#getMembers <em>Members</em>}</li>
 *   <li>{@link org.servicifi.gelato.language.kernel.procedures.impl.MainProcedureImpl#getStart <em>Start</em>}</li>
 *   <li>{@link org.servicifi.gelato.language.kernel.procedures.impl.MainProcedureImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MainProcedureImpl extends LabellableElementImpl implements MainProcedure {
	...
	public EList<Member> getMembers() {
		if (members == null) {
			members = new EObjectContainmentEList<Member>(Member.class, this, ProceduresPackage.MAIN_PROCEDURE__MEMBERS);
		}
		return members;
	}
	...
	public NotificationChain basicSetStart(Start newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProceduresPackage.MAIN_PROCEDURE__START, oldStart, newStart);
	...
	public void setStart(Start newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject)start).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProceduresPackage.MAIN_PROCEDURE__START, null, msgs);
			if (newStart != null)
				msgs = ((InternalEObject)newStart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProceduresPackage.MAIN_PROCEDURE__START, null, msgs);
			msgs = basicSetStart(newStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProceduresPackage.MAIN_PROCEDURE__START, newStart, newStart));
	}
	...
	public End getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProceduresPackage.MAIN_PROCEDURE__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public void setEnd(End newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProceduresPackage.MAIN_PROCEDURE__END, oldEnd, end));
	}
