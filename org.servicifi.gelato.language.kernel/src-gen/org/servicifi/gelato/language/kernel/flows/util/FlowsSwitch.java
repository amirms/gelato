 ...
 * @generated
 */
public class FlowsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FlowsPackage.FLOW: {
				Flow flow = (Flow)theEObject;
				T result = caseFlow(flow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowsPackage.REGULAR_FLOW: {
			...
			case FlowsPackage.PROCEDURE_FLOW: {
			...
			case FlowsPackage.SUMMARY_FLOW: {
