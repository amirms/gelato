...
public class AnalysesFactoryImpl extends EFactoryImpl implements AnalysesFactory {
	...
	public ReachingDefinitionsAnalysis createReachingDefinitionsAnalysis(EList<Flow> cfg){
		ReachingDefinitionsAnalysisImpl reachingDefinitionsAnalysis = new ReachingDefinitionsAnalysisImpl(cfg);
		return reachingDefinitionsAnalysis;
	}
	...
	public ExitEntryPair createExitEntryPair(EList<AnalysisResult> exit,
			EList<AnalysisResult> entry){
		ExitEntryPairImpl exitEntryPair = new ExitEntryPairImpl(exit, entry);
