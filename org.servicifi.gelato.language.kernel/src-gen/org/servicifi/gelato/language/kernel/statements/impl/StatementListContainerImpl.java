 ...
 * </p>
 * <ul>
 *   <li>{@link org.servicifi.gelato.language.kernel.statements.impl.StatementListContainerImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StatementListContainerImpl extends EObjectImpl implements StatementListContainer {
	/**
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this, StatementsPackage.STATEMENT_LIST_CONTAINER__STATEMENTS);
		}
		return statements;
	}
