 ...
 * </p>
 * <ul>
 * <li>{@link org.servicifi.gelato.language.kernel.statements.impl.ConditionImpl#getStatement
 * <em>Statement</em>}</li>
 * <li>{@link org.servicifi.gelato.language.kernel.statements.impl.ConditionImpl#getCondition
 * <em>Condition</em>}</li>
 * <li>{@link org.servicifi.gelato.language.kernel.statements.impl.ConditionImpl#getElseStatement
 * <em>Else Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionImpl extends StatementImpl implements Condition {
	...
	/**
	 * The cached value of the '{@link #getElseStatement() <em>Else Statement</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public EList<Flow> internalFlow() {
		...
		// FIXME
		if (getElseStatement() != null)
			res.add(GraphsFactory.eINSTANCE.createRegularFlow(getCondition(), getElseStatement().first()));
