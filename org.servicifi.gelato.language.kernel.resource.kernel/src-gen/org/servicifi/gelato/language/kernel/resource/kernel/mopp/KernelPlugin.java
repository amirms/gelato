 ...
 */
public class KernelPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.servicifi.gelato.language.kernel.resource.kernel";
	/**
	...
	public static KernelPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, KernelPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, KernelPlugin.PLUGIN_ID, message);
		}
		final KernelPlugin pluginInstance = KernelPlugin.getDefault();
