...
public class KernelProblem implements org.servicifi.gelato.language.kernel.resource.kernel.IKernelProblem {
	...
	private Collection<org.servicifi.gelato.language.kernel.resource.kernel.IKernelQuickFix> quickFixes;
	...
	public KernelProblem(String message, org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType type, org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemSeverity severity) {
		this(message, type, severity, Collections.<org.servicifi.gelato.language.kernel.resource.kernel.IKernelQuickFix>emptySet());
	}
	...
	public KernelProblem(String message, org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType type, org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemSeverity severity, Collection<org.servicifi.gelato.language.kernel.resource.kernel.IKernelQuickFix> quickFixes) {
		super();
		this.message = message;
		this.type = type;
		this.severity = severity;
		this.quickFixes = new LinkedHashSet<org.servicifi.gelato.language.kernel.resource.kernel.IKernelQuickFix>();
