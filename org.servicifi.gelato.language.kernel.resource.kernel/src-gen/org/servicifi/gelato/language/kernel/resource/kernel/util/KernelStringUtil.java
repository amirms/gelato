...
public class KernelStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.servicifi.gelato.language.kernel.resource.kernel.IKernelFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.servicifi.gelato.language.kernel.resource.kernel.IKernelFunction1<String, T> toStringFunction) {
