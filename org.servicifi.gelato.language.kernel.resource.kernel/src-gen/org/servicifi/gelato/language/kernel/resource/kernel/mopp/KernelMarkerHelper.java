 ...
 * contains
 * <code>org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextDiagnostic
 * </code>s it uses the more precise information of this extended diagnostic type.
 */
public class KernelMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.servicifi.gelato.language.kernel.resource.kernel.IKernelCommand<Object>> commands = new java.util.ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.servicifi.gelato.language.kernel.resource.kernel.IKernelCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.servicifi.gelato.language.kernel.resource.kernel.IKernelCommand<Object>> commandsToProcess = new java.util.ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.servicifi.gelato.language.kernel.resource.kernel.IKernelCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextDiagnostic diagnostic) {
		final org.servicifi.gelato.language.kernel.resource.kernel.IKernelProblem problem = diagnostic.getProblem();
		org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.servicifi.gelato.language.kernel.resource.kernel.IKernelCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemSeverity.ERROR) {
					...
					org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextDiagnostic textDiagnostic = (org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.servicifi.gelato.language.kernel.resource.kernel.IKernelQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.servicifi.gelato.language.kernel.resource.kernel.util.KernelStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType nextType : org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.servicifi.gelato.language.kernel.resource.kernel.util.KernelRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.servicifi.gelato.language.kernel.resource.kernel.IKernelCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
