 ...
 * code).
 */
public class KernelDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.servicifi.gelato.language.kernel.resource.kernel.debug.AbstractKernelDebuggable debuggable;
	/**
	...
	public KernelDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		while (!stop) {
			...
			if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.servicifi.gelato.language.kernel.resource.kernel.util.KernelStringUtil.encode('#', stack);
				org.servicifi.gelato.language.kernel.resource.kernel.debug.KernelDebugMessage message = new org.servicifi.gelato.language.kernel.resource.kernel.debug.KernelDebugMessage(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				...
				org.servicifi.gelato.language.kernel.resource.kernel.debug.KernelDebugMessage message = new org.servicifi.gelato.language.kernel.resource.kernel.debug.KernelDebugMessage(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.GET_VARIABLES)) {
				...
				org.servicifi.gelato.language.kernel.resource.kernel.debug.KernelDebugMessage message = new org.servicifi.gelato.language.kernel.resource.kernel.debug.KernelDebugMessage(org.servicifi.gelato.language.kernel.resource.kernel.debug.EKernelDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.servicifi.gelato.language.kernel.resource.kernel.util.KernelStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.servicifi.gelato.language.kernel.resource.kernel.util.KernelPair<String, Object> pair = new org.servicifi.gelato.language.kernel.resource.kernel.util.KernelPair<String, Object>(name, value);
	...
	public org.servicifi.gelato.language.kernel.resource.kernel.debug.AbstractKernelDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.servicifi.gelato.language.kernel.resource.kernel.debug.AbstractKernelDebuggable debuggable) {
