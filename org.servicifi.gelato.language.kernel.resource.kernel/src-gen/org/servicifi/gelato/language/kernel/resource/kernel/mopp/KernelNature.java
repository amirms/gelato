...
public class KernelNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.servicifi.gelato.language.kernel.resource.kernel.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
