 ...
 */
public class KernelBracketPair implements org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair {
	...
	public KernelBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;
