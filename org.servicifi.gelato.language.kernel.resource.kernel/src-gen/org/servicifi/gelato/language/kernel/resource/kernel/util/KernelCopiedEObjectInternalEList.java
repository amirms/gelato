...
public class KernelCopiedEObjectInternalEList extends org.servicifi.gelato.language.kernel.resource.kernel.util.KernelCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public KernelCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
