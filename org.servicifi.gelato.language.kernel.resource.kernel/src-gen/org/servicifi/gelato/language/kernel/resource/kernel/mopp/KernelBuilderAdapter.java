...
public class KernelBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.servicifi.gelato.language.kernel.resource.kernel.builder";
	
	private org.servicifi.gelato.language.kernel.resource.kernel.IKernelBuilder defaultBuilder = new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.servicifi.gelato.language.kernel.resource.kernel.IKernelBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelResource customResource = (org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelResource) resourceSet.getResource(uri, true);
			new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.servicifi.gelato.language.kernel.resource.kernel.IKernelBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMarkerHelper().getMarkerID(org.servicifi.gelato.language.kernel.resource.kernel.KernelEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelTaskItemBuilder taskItemBuilder = new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelTaskItemBuilder();
		new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMetaInformation().getSyntaxName())) {
