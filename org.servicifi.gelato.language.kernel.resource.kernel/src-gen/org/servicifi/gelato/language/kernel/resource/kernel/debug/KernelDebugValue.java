...
public class KernelDebugValue extends org.servicifi.gelato.language.kernel.resource.kernel.debug.KernelDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public KernelDebugValue(org.servicifi.gelato.language.kernel.resource.kernel.debug.KernelDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
