	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = org.servicifi.gelato.language.kernel.resource.kernel.util.KernelListUtil.copySafelyToObjectList(currentValueAsList);
