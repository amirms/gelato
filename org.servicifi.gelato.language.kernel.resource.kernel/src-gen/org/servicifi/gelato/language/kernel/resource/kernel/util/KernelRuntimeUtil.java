 ...
 */
public class KernelRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
