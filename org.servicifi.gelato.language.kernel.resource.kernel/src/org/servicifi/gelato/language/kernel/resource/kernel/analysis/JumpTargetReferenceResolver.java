...
public class JumpTargetReferenceResolver implements org.servicifi.gelato.language.kernel.resource.kernel.IKernelReferenceResolver<org.servicifi.gelato.language.kernel.statements.Jump, org.servicifi.gelato.analysis.framework.commons.LabellableElement> {
	...
	public void resolve(String identifier, org.servicifi.gelato.language.kernel.statements.Jump container, EReference reference, int position, boolean resolveFuzzy, final org.servicifi.gelato.language.kernel.resource.kernel.IKernelReferenceResolveResult<org.servicifi.gelato.analysis.framework.commons.LabellableElement> result) {
		...
		while (iterator.hasNext()) {		
			...
			if (((LabellableElement) currentObject).getLabel() == Long.parseLong(identifier)) {
	...
	public String deResolve(org.servicifi.gelato.analysis.framework.commons.LabellableElement element, org.servicifi.gelato.language.kernel.statements.Jump container, EReference reference) {
