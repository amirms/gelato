...
public class PreprocessMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessResource) {
					org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessResource customResource = (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessQuickFix> getQuickFixes(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextResource resource, org.eclipse.core.resources.IMarker marker) {
		java.util.Collection<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessQuickFix> foundQuickFixes = new java.util.ArrayList<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessQuickFix>();
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
