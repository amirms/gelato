 ...
 */
public class PreprocessHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public PreprocessHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
