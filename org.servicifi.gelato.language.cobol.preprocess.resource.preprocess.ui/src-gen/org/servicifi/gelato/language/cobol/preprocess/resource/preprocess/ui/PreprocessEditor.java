 ...
 * </p>
 */
public class PreprocessEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessResourceProvider, org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.IPreprocessBracketHandlerProvider, org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.IPreprocessAnnotationModelProvider {
	...
	private java.util.Collection<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBackgroundParsingListener>();
	...
	public PreprocessEditor() {
		super();
		setSourceViewerConfiguration(new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessSourceViewerConfiguration(this, this, this, colorManager));
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextResource) {
					...
					org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the PreprocessEditor.");
