 ...
 * @since 3.2
 */
public class PreprocessBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	 ...
	 */
	public PreprocessBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public PreprocessBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public PreprocessBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
