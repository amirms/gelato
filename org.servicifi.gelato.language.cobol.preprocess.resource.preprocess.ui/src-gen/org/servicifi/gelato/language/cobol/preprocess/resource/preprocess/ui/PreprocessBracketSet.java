 ...
 */
public class PreprocessBracketSet {
	...
	private java.util.ArrayList<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair {
	 ...
	 */
	private class ClosingListener implements org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.IPreprocessBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public PreprocessBracketSet(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair>();
	 ...
	 */
	public org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair getBracketPair(String opening, String closing) {
		for (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair bracketPair : bracketPairs) {
	...
	public org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair remove(String opening, String closing) {
		for (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
