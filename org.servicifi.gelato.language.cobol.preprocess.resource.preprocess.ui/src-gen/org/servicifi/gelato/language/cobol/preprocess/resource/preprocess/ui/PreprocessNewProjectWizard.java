 ...
 */
public class PreprocessNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public PreprocessNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui");
							...
							String natureID = org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessNature.NATURE_ID;
							...
							for (String builderID : org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessMetaInformation info = new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIPlugin.getDefault().getBundle();
