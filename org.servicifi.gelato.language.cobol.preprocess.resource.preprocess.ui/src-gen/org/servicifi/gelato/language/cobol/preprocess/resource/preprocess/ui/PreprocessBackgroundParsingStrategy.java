 ...
 */
public class PreprocessBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextResource resource, final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextResource resource, final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextResource resource, final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessResource) {
							org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessResource concreteResource = (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessResource) resource;
