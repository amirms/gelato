...
public class PreprocessToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor = null;
		
		if (editorPart instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor) {
			editor = (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor) editorPart;
