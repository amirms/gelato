 ...
 * olInput</code>.
 */
public class PreprocessDocBrowserInformationControlInput {
	
	private final PreprocessDocBrowserInformationControlInput fPrevious;
	private PreprocessDocBrowserInformationControlInput fNext;
	 ...
	 */
	public PreprocessDocBrowserInformationControlInput(PreprocessDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public PreprocessDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public PreprocessDocBrowserInformationControlInput getNext() {
		return fNext;
	}
