 ...
 * a specified depth.
 */
public class PreprocessOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public PreprocessOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.util.PreprocessStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessPlugin.logError("Exception while refreshing outline view", e);
		}
	}
