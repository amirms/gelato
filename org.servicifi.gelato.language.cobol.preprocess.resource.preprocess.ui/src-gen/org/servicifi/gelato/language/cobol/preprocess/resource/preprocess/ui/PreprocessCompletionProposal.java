 ...
 */
public class PreprocessCompletionProposal implements Comparable<PreprocessCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessExpectedTerminal expectedTerminal;
	...
	public PreprocessCompletionProposal(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public PreprocessCompletionProposal(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public PreprocessCompletionProposal(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof PreprocessCompletionProposal) {
			PreprocessCompletionProposal other = (PreprocessCompletionProposal) object;
	...
	public int compareTo(PreprocessCompletionProposal object) {
		if (object instanceof PreprocessCompletionProposal) {
			PreprocessCompletionProposal other = (PreprocessCompletionProposal) object;
