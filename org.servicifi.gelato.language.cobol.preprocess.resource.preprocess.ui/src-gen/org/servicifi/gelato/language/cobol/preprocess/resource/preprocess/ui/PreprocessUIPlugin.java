 ...
 */
public class PreprocessUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui";
	public static final String EDITOR_ID = "org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor";
	...
	private static PreprocessUIPlugin plugin;
	
	public PreprocessUIPlugin() {
		super();
	}
	...
	public static PreprocessUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, PreprocessUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, PreprocessUIPlugin.PLUGIN_ID, message);
		}
		final PreprocessUIPlugin pluginInstance = PreprocessUIPlugin.getDefault();
