...
public class PreprocessPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		...
		setDescription(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIResourceBundle.ROOT_PREFERENCE_PAGE_DESCRIPTION);
	}
	...
	protected Control createContents(Composite parent) {
		...
		link.setText(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIResourceBundle.ROOT_PREFERENCE_PAGE_TEXT);
		link.setSize(140, 40);
