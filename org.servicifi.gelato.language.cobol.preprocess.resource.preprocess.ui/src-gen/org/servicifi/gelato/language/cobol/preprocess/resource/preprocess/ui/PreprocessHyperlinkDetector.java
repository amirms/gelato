 ...
 * hovers, is a proxy.
 */
public class PreprocessHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public PreprocessHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
