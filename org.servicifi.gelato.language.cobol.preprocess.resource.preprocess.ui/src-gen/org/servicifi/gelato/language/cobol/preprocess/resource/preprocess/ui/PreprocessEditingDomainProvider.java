 ...
 * editor input.
 */
public class PreprocessEditingDomainProvider {
	...
	private EditingDomain createEditingDomain() {
		...
		new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.mopp.PreprocessMetaInformation().registerResourceFactory();
