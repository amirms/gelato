...
/**
 * The PreprocessAutoEditStrategy extends the default auto edit strategy such that
 * an additional tab is added if a line break is entered after opening brackets
 * which are configured as <code>closeAfterEnter</code>. Also, closing brackets
 * are automatically inserted right away when opening brackets are added where
 * <code>closeAfterEnter</code> is set to <code>false</code>.
 */
public class PreprocessAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBracketSet bracketSet;
	
	public PreprocessAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBracketSet bracketSet) {
