 ...
 */
public class PreprocessTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput infoInput = (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHyperlink hyperlink = new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBrowserInformationControl iControl = new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput) {
							org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput input = (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBrowserInformationControl.isAvailable(parent)) {
				org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBrowserInformationControl iControl = new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public PreprocessTextHover(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHTMLPrinter.insertPageProlog(buffer, 0, org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessTextHover.getStyleSheet());
			org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHTMLPrinter.addPageEpilog(buffer);
			return new org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.util.PreprocessStreamUtil.getContent(styleSheetURL.openStream());
