 ...
 */
public class PreprocessCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor) {
				org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor = (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor) workbenchPart;
	...
	protected org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor;
	 ...
	 */
	public PreprocessCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor textEditor) {
	...
	private void addCloseListener(final org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.ui.PreprocessUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextResource textResource = (org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.IPreprocessTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
