 ...
 */
public class PreprocessIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.servicifi.gelato.language.cobol.preprocess.resource.preprocess.grammar.PreprocessGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
