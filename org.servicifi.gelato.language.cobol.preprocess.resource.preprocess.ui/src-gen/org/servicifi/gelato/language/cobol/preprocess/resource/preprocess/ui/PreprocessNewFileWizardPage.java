 ...
 */
public class PreprocessNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public PreprocessNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new preprocess file");
