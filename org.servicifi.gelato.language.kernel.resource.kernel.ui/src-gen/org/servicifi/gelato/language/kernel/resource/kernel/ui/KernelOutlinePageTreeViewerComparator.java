...
public class KernelOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			org.servicifi.gelato.language.kernel.resource.kernel.IKernelNameProvider nameProvider = new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMetaInformation().createNameProvider();
