 ...
 * a specified depth.
 */
public class KernelOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public KernelOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.servicifi.gelato.language.kernel.resource.kernel.util.KernelStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelPlugin.logError("Exception while refreshing outline view", e);
		}
	}
