...
public class KernelToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor = null;
		
		if (editorPart instanceof org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor) {
			editor = (org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor) editorPart;
