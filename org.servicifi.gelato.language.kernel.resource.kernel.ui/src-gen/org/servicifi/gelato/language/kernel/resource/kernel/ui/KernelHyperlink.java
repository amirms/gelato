 ...
 */
public class KernelHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public KernelHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
