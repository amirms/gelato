 ...
 * hovers, is a proxy.
 */
public class KernelHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public KernelHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
