 ...
 */
public class KernelTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.servicifi.gelato.language.kernel.resource.kernel.IKernelHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput infoInput = (org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHyperlink hyperlink = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBrowserInformationControl iControl = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput) {
							org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput input = (org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBrowserInformationControl.isAvailable(parent)) {
				org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBrowserInformationControl iControl = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public KernelTextHover(org.servicifi.gelato.language.kernel.resource.kernel.IKernelResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHTMLPrinter.insertPageProlog(buffer, 0, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelTextHover.getStyleSheet());
			org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHTMLPrinter.addPageEpilog(buffer);
			return new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.servicifi.gelato.language.kernel.resource.kernel.util.KernelStreamUtil.getContent(styleSheetURL.openStream());
