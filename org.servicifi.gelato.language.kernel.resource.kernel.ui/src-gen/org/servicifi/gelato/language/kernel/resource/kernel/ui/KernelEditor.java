 ...
 * </p>
 */
public class KernelEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.servicifi.gelato.language.kernel.resource.kernel.IKernelResourceProvider, org.servicifi.gelato.language.kernel.resource.kernel.ui.IKernelBracketHandlerProvider, org.servicifi.gelato.language.kernel.resource.kernel.ui.IKernelAnnotationModelProvider {
	...
	private java.util.Collection<org.servicifi.gelato.language.kernel.resource.kernel.IKernelBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelBackgroundParsingListener>();
	...
	public KernelEditor() {
		super();
		setSourceViewerConfiguration(new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelSourceViewerConfiguration(this, this, this, colorManager));
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource) {
					...
					org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the KernelEditor.");
