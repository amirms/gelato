 ...
 */
public class KernelNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public KernelNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new kernel file");
