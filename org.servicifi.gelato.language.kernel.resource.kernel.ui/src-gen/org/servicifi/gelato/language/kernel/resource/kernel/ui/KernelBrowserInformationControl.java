 ...
 * @since 3.2
 */
public class KernelBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput fInput;
	 ...
	 */
	public KernelBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public KernelBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public KernelBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput);
		...
		fInput= (org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput) input;
		...
		org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelDocBrowserInformationControlInput getInput() {
		return fInput;
	}
