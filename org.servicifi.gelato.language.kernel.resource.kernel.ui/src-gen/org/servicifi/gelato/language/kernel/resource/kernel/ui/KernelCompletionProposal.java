 ...
 */
public class KernelCompletionProposal implements Comparable<KernelCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelExpectedTerminal expectedTerminal;
	...
	public KernelCompletionProposal(org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public KernelCompletionProposal(org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public KernelCompletionProposal(org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof KernelCompletionProposal) {
			KernelCompletionProposal other = (KernelCompletionProposal) object;
	...
	public int compareTo(KernelCompletionProposal object) {
		if (object instanceof KernelCompletionProposal) {
			KernelCompletionProposal other = (KernelCompletionProposal) object;
