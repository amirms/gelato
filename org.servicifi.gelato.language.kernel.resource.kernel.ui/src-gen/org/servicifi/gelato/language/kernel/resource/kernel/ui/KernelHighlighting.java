 ...
 */
public class KernelHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelTokenScanner scanner;
	...
	private org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelOccurrence occurrence;
	private org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.servicifi.gelato.language.kernel.resource.kernel.IKernelBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public KernelHighlighting(org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelColorManager colorManager, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelTokenScanner(textResource, colorManager);
		occurrence = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
