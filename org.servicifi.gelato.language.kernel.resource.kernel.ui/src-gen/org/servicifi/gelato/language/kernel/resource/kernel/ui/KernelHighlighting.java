 ...
 */
public class KernelHighlighting implements ISelectionProvider, ISelectionChangedListener {
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.servicifi.gelato.language.kernel.resource.kernel.IKernelBackgroundParsingListener {
	 ...
	 */
	public KernelHighlighting(org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource textResource, ProjectionViewer projectionViewer, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelColorManager colorManager, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelOccurrence(textResource, projectionViewer);
		this.bracketSet = new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPositionCategory.BRACKET.toString());
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		...
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
