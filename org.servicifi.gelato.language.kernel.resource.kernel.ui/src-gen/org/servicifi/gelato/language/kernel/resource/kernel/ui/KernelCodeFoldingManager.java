 ...
 */
public class KernelCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.servicifi.gelato.language.kernel.resource.kernel.IKernelBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor) {
				org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor = (org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor) workbenchPart;
	...
	protected org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor;
	 ...
	 */
	public KernelCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor textEditor) {
	...
	private void addCloseListener(final org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource textResource = (org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
