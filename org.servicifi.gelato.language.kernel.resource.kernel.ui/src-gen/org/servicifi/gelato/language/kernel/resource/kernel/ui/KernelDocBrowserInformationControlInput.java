 ...
 * olInput</code>.
 */
public class KernelDocBrowserInformationControlInput {
	
	private final KernelDocBrowserInformationControlInput fPrevious;
	private KernelDocBrowserInformationControlInput fNext;
	 ...
	 */
	public KernelDocBrowserInformationControlInput(KernelDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public KernelDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public KernelDocBrowserInformationControlInput getNext() {
		return fNext;
	}
