 ...
 */
public class KernelNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.servicifi.gelato.language.kernel.resource.kernel.ui");
							...
							String natureID = org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelNature.NATURE_ID;
							...
							for (String builderID : org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMetaInformation info = new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIPlugin.getDefault().getBundle();
