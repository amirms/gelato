 ...
 * </p>
 */
public class KernelNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelNewProjectWizardLo
	 * gic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		IPath path = new Path(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_ICON);
		Bundle bundle = org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIPlugin.getDefault().getBundle();
		...
		setWindowTitle(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelUIResourceBundle.NEW_PROJECT_WIZARD_WINDOW_TITLE);
	}
