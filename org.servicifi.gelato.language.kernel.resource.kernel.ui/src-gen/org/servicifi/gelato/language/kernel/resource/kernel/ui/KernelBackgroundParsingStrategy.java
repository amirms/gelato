 ...
 */
public class KernelBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource resource, final org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource resource, final org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.servicifi.gelato.language.kernel.resource.kernel.IKernelTextResource resource, final org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelResource) {
							org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelResource concreteResource = (org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelResource) resource;
