...
public class KernelBracketSet {
	...
	private java.util.ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair {
	 ...
	 */
	private class ClosingListener implements org.servicifi.gelato.language.kernel.resource.kernel.ui.IKernelBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public KernelBracketSet(org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair>();
	 ...
	 */
	public org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair getBracketPair(String opening, String closing) {
		for (org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair bracketPair : bracketPairs) {
	...
	public org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair remove(String opening, String closing) {
		for (org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
