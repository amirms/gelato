...
public class KernelBracketSet {
	...
	private ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public KernelBracketSet() {
		super();
		this.languageID = new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMetaInformation().getSyntaxName();
		this.bracketPairs = new ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair>();
	}
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<org.servicifi.gelato.language.kernel.resource.kernel.IKernelBracketPair>();
