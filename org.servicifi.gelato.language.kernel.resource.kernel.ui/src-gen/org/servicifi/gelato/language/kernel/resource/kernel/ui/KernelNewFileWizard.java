...
public class KernelNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelNewFileWizardPage page;
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.servicifi.gelato.language.kernel.resource.kernel.mopp.KernelMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
