 ...
 */
public class KernelUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.servicifi.gelato.language.kernel.resource.kernel.ui";
	public static final String EDITOR_ID = "org.servicifi.gelato.language.kernel.resource.kernel.ui.KernelEditor";
	...
	private static KernelUIPlugin plugin;
	
	public KernelUIPlugin() {
		super();
	}
	...
	public static KernelUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, KernelUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, KernelUIPlugin.PLUGIN_ID, message);
		}
		final KernelUIPlugin pluginInstance = KernelUIPlugin.getDefault();
