...
public class CobolNature implements IProjectNature {
	
	public static final String NATURE_ID = "org.servicifi.gelato.language.cobol.resource.cobol.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
