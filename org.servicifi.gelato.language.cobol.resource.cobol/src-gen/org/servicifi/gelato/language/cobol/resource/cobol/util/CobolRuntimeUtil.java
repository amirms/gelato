...
public class CobolRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
