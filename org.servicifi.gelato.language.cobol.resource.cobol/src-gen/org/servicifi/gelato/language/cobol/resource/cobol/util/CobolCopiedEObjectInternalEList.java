...
public class CobolCopiedEObjectInternalEList extends org.servicifi.gelato.language.cobol.resource.cobol.util.CobolCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public CobolCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
