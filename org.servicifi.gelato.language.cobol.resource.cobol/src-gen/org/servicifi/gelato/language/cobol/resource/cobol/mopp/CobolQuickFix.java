...
public abstract class CobolQuickFix implements org.servicifi.gelato.language.cobol.resource.cobol.ICobolQuickFix {
	...
	public CobolQuickFix(String displayString, String imageKey, EObject contextObject) {
		this(displayString, imageKey, Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public CobolQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public CobolQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects, Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new org.servicifi.gelato.language.cobol.resource.cobol.util.CobolRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
