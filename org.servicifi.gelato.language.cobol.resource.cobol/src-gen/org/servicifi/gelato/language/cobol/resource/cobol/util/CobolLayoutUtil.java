...
public class CobolLayoutUtil {
	...
	public void transferLayoutInformationToModel(EObject element) {
		...
		for (Iterator<org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(EObject element) {
		...
		if (layoutReference != null) {
			...
			for (Iterator<EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public EObject createLayoutInformationModelElement(org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolLayoutInformation layoutInformation, EPackage layoutPackage) {
		EFactory factory = layoutPackage.getEFactoryInstance();
		Object object = layoutInformation.getObject(null, false);
		org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolLayoutInformation createLayoutInformation(EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolSyntaxElement syntaxElement = org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolPlaceholder) {
			org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolPlaceholder placeholder = (org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolPlaceholder) syntaxElement;
			org.servicifi.gelato.language.cobol.resource.cobol.ICobolTokenResolver tokenResolver = new org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.servicifi.gelato.language.cobol.resource.cobol.ICobolTokenResolveResult result = new org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolLayoutInformationAdapter getLayoutInformationAdapter(EObject element) {
	...
	public void removeLayoutInformationAdapter(EObject element) {
		org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolLayoutInformationAdapter existingAdapter = getLayoutInformationAdapter(element);
