 ...
 */
public class CobolBracketPair implements org.servicifi.gelato.language.cobol.resource.cobol.ICobolBracketPair {
	...
	public CobolBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;
