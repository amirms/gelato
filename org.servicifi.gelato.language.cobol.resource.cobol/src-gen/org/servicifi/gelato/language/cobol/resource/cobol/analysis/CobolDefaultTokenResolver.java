 ...
 * </p>
 */
public class CobolDefaultTokenResolver implements org.servicifi.gelato.language.cobol.resource.cobol.ICobolTokenResolver {
	 ...
	 */
	public CobolDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public CobolDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, org.servicifi.gelato.language.cobol.resource.cobol.ICobolTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.servicifi.gelato.language.cobol.resource.cobol.grammar.CobolGrammarInformationProvider.INSTANCE.getKeywords()) {
