 ...
 * to 4 bytes).
 */
public class CobolUnicodeConverter extends org.servicifi.gelato.language.cobol.resource.cobol.mopp.CobolInputStreamProcessor {
	 ...
	 */
	public CobolUnicodeConverter(InputStream inputStream) {
