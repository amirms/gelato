 ...
 * @generated
 */
public class RegistersAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public RegistersAdapterFactory() {
	 ...
	 * @generated
	 */
	protected RegistersSwitch<Adapter> modelSwitch =
		new RegistersSwitch<Adapter>() {
			@Override
			public Adapter caseRegister(Register object) {
				return createRegisterAdapter();
			}
			@Override
			public Adapter caseShiftIn(ShiftIn object) {
				return createShiftInAdapter();
			}
			@Override
			public Adapter caseShiftOut(ShiftOut object) {
				return createShiftOutAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseLengthOf(LengthOf object) {
				return createLengthOfAdapter();
			}
			@Override
			public Adapter caseReturnCode(ReturnCode object) {
				return createReturnCodeAdapter();
			}
			@Override
			public Adapter caseWhenCompiled(WhenCompiled object) {
				return createWhenCompiledAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.registers.Register <em>Register</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.registers.ShiftIn <em>Shift In</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createShiftInAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.registers.ShiftOut <em>Shift Out</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createShiftOutAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.registers.AddressOf <em>Address Of</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.registers.LengthOf <em>Length Of</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.registers.ReturnCode <em>Return Code</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createReturnCodeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.registers.WhenCompiled <em>When Compiled</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createWhenCompiledAdapter() {
		return null;
	}
