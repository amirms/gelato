...
import org.servicifi.gelato.language.cobol.registers.RegistersFactory;
 ...
 * @generated
 */
public class RegistersPackageImpl extends EPackageImpl implements RegistersPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass shiftInEClass = null;
	 ...
	 * @generated
	 */
	private EClass shiftOutEClass = null;
	 ...
	 * @generated
	 */
	private EClass lengthOfEClass = null;
	 ...
	 * @generated
	 */
	private EClass returnCodeEClass = null;
	 ...
	 * @generated
	 */
	private EClass whenCompiledEClass = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.registers.RegistersPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RegistersPackageImpl() {
		super(eNS_URI, RegistersFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link RegistersPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RegistersPackage init() {
		if (isInited) return (RegistersPackage)EPackage.Registry.INSTANCE.getEPackage(RegistersPackage.eNS_URI);

		// Obtain or create and register package
		RegistersPackageImpl theRegistersPackage = (RegistersPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RegistersPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RegistersPackageImpl());
		...
		theRegistersPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RegistersPackage.eNS_URI, theRegistersPackage);
		return theRegistersPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getRegister_Operand() {
	 ...
	 * @generated
	 */
	public EClass getShiftIn() {
		return shiftInEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getShiftOut() {
		return shiftOutEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getReturnCode() {
		return returnCodeEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getWhenCompiled() {
		return whenCompiledEClass;
	}
	 ...
	 * @generated
	 */
	public RegistersFactory getRegistersFactory() {
		return (RegistersFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(registerEClass, REGISTER__OPERAND);

		shiftInEClass = createEClass(SHIFT_IN);

		shiftOutEClass = createEClass(SHIFT_OUT);

		addressOfEClass = createEClass(ADDRESS_OF);

		lengthOfEClass = createEClass(LENGTH_OF);

		returnCodeEClass = createEClass(RETURN_CODE);

		whenCompiledEClass = createEClass(WHEN_COMPILED);
	}
	...
	public void initializePackageContents() {
		...
		registerEClass.getESuperTypes().add(theOperandsPackage.getPrimaryOperand());
		shiftInEClass.getESuperTypes().add(this.getRegister());
		shiftOutEClass.getESuperTypes().add(this.getRegister());
		addressOfEClass.getESuperTypes().add(this.getRegister());
		lengthOfEClass.getESuperTypes().add(this.getRegister());
		returnCodeEClass.getESuperTypes().add(this.getRegister());
		whenCompiledEClass.getESuperTypes().add(this.getRegister());

		// Initialize classes and features; add operations and parameters
		initEClass(registerEClass, Register.class, "Register", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRegister_Operand(), theOperandsPackage.getPrimaryOperand(), null, "operand", null, 1, 1, Register.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(shiftInEClass, ShiftIn.class, "ShiftIn", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(shiftOutEClass, ShiftOut.class, "ShiftOut", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(addressOfEClass, AddressOf.class, "AddressOf", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lengthOfEClass, LengthOf.class, "LengthOf", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(returnCodeEClass, ReturnCode.class, "ReturnCode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(whenCompiledEClass, WhenCompiled.class, "WhenCompiled", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //RegistersPackageImpl
