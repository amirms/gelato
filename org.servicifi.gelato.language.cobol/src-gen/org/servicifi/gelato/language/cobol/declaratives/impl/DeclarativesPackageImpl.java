...
import org.servicifi.gelato.language.cobol.declaratives.DeclarativesFactory;
 ...
 * @generated
 */
public class DeclarativesPackageImpl extends EPackageImpl implements DeclarativesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass declarativesEClass = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.declaratives.DeclarativesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DeclarativesPackageImpl() {
		super(eNS_URI, DeclarativesFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link DeclarativesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DeclarativesPackage init() {
		if (isInited) return (DeclarativesPackage)EPackage.Registry.INSTANCE.getEPackage(DeclarativesPackage.eNS_URI);

		// Obtain or create and register package
		DeclarativesPackageImpl theDeclarativesPackage = (DeclarativesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DeclarativesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DeclarativesPackageImpl());
		...
		theDeclarativesPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DeclarativesPackage.eNS_URI, theDeclarativesPackage);
		return theDeclarativesPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getDeclaratives_DeclarativeSections() {
		return (EReference)declarativesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public DeclarativesFactory getDeclarativesFactory() {
		return (DeclarativesFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		declarativesEClass = createEClass(DECLARATIVES);
		createEReference(declarativesEClass, DECLARATIVES__DECLARATIVE_SECTIONS);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(declarativesEClass, Declaratives.class, "Declaratives", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDeclaratives_DeclarativeSections(), theSectionsPackage.getDeclarativeSection(), null, "declarativeSections", null, 1, -1, Declaratives.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //DeclarativesPackageImpl
