...
import org.servicifi.gelato.language.cobol.ios.IosFactory;
 ...
 * @generated
 */
public class IosPackageImpl extends EPackageImpl implements IosPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass inputProcedureEClass = null;
	 ...
	 * @generated
	 */
	private EClass inputDirectiveEClass = null;
	 ...
	 * @generated
	 */
	private EClass outputDirectiveEClass = null;
	 ...
	 * @generated
	 */
	private EClass outputProcedureEClass = null;
	 ...
	 * @generated
	 */
	private EClass ioDirectivesEClass = null;
	 ...
	 * @generated
	 */
	private EClass fileDirectiveEClass = null;
	 ...
	 * @generated
	 */
	private EClass procedureDirectiveEClass = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.ios.IosPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IosPackageImpl() {
		super(eNS_URI, IosFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link IosPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static IosPackage init() {
		if (isInited) return (IosPackage)EPackage.Registry.INSTANCE.getEPackage(IosPackage.eNS_URI);

		// Obtain or create and register package
		IosPackageImpl theIosPackage = (IosPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof IosPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new IosPackageImpl());
		...
		theIosPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IosPackage.eNS_URI, theIosPackage);
		return theIosPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getInputProcedure() {
		return inputProcedureEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getInputDirective() {
		return inputDirectiveEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getOutputDirective() {
		return outputDirectiveEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getOutputProcedure() {
		return outputProcedureEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getIODirectives() {
		return ioDirectivesEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getFileDirective() {
		return fileDirectiveEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getFileDirective_FileNames() {
		return (EReference)fileDirectiveEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getProcedureDirective() {
		return procedureDirectiveEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getProcedureDirective_Label() {
		return (EReference)procedureDirectiveEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public IosFactory getIosFactory() {
		return (IosFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		inputProcedureEClass = createEClass(INPUT_PROCEDURE);

		inputDirectiveEClass = createEClass(INPUT_DIRECTIVE);

		inputFileEClass = createEClass(INPUT_FILE);

		outputDirectiveEClass = createEClass(OUTPUT_DIRECTIVE);

		outputProcedureEClass = createEClass(OUTPUT_PROCEDURE);

		outputFileEClass = createEClass(OUTPUT_FILE);

		ioDirectivesEClass = createEClass(IO_DIRECTIVES);

		fileDirectiveEClass = createEClass(FILE_DIRECTIVE);
		createEReference(fileDirectiveEClass, FILE_DIRECTIVE__FILE_NAMES);

		procedureDirectiveEClass = createEClass(PROCEDURE_DIRECTIVE);
		createEReference(procedureDirectiveEClass, PROCEDURE_DIRECTIVE__LABEL);
	}
	...
	public void initializePackageContents() {
		...
		inputProcedureEClass.getESuperTypes().add(this.getInputDirective());
		inputProcedureEClass.getESuperTypes().add(this.getProcedureDirective());
		inputDirectiveEClass.getESuperTypes().add(this.getIODirectives());
		inputFileEClass.getESuperTypes().add(this.getInputDirective());
		inputFileEClass.getESuperTypes().add(this.getFileDirective());
		outputDirectiveEClass.getESuperTypes().add(this.getIODirectives());
		outputProcedureEClass.getESuperTypes().add(this.getProcedureDirective());
		outputProcedureEClass.getESuperTypes().add(this.getOutputDirective());
		outputFileEClass.getESuperTypes().add(this.getOutputDirective());
		outputFileEClass.getESuperTypes().add(this.getFileDirective());
		fileDirectiveEClass.getESuperTypes().add(this.getIODirectives());
		procedureDirectiveEClass.getESuperTypes().add(this.getIODirectives());

		// Initialize classes and features; add operations and parameters
		initEClass(inputProcedureEClass, InputProcedure.class, "InputProcedure", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(inputDirectiveEClass, InputDirective.class, "InputDirective", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(inputFileEClass, InputFile.class, "InputFile", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(outputDirectiveEClass, OutputDirective.class, "OutputDirective", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(outputProcedureEClass, OutputProcedure.class, "OutputProcedure", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(outputFileEClass, OutputFile.class, "OutputFile", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(ioDirectivesEClass, IODirectives.class, "IODirectives", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(fileDirectiveEClass, FileDirective.class, "FileDirective", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFileDirective_FileNames(), theReferencesPackage.getFileNameReference(), null, "fileNames", null, 1, -1, FileDirective.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(procedureDirectiveEClass, ProcedureDirective.class, "ProcedureDirective", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProcedureDirective_Label(), theLabelsPackage.getLabel(), null, "label", null, 1, 1, ProcedureDirective.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
