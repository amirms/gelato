...
public class ContainersSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ContainersPackage.COMPILATION_GROUP: {
				CompilationGroup compilationGroup = (CompilationGroup)theEObject;
				T result = caseCompilationGroup(compilationGroup);
				if (result == null) result = caseCobolRoot(compilationGroup);
				if (result == null) result = caseNamedElement(compilationGroup);
				if (result == null) result = caseCommentable(compilationGroup);
			...
			case ContainersPackage.COBOL_ROOT: {
				CobolRoot cobolRoot = (CobolRoot)theEObject;
				T result = caseCobolRoot(cobolRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContainersPackage.EMPTY_MODEL: {
				...
				if (result == null) result = caseCobolRoot(emptyModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Compilation Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Compilation Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCompilationGroup(CompilationGroup object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cobol Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cobol Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCobolRoot(CobolRoot object) {
		return null;
	}
