...
public abstract class ArgumentImpl extends EObjectImpl implements Argument {
	...
	public EList<PrimaryOperand> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<PrimaryOperand>(PrimaryOperand.class, this, FunctionsPackage.ARGUMENT__OPERANDS);
		}
		return operands;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionsPackage.ARGUMENT__OPERANDS:
