...
import org.servicifi.gelato.language.cobol.functions.FunctionsFactory;
...
public class FunctionsPackageImpl extends EPackageImpl implements FunctionsPackage {
	 ...
	 * @generated
	 */
	private EClass byReferenceArgumentEClass = null;
	 ...
	 * @generated
	 */
	private EClass byValueArgumentEClass = null;
	 ...
	 * @generated
	 */
	private EClass byContentArgumentEClass = null;
	 ...
	 * @generated
	 */
	private EClass omittedArgumentEClass = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.functions.FunctionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getArgument_Operands() {
	 ...
	 * @generated
	 */
	public EClass getByReferenceArgument() {
		return byReferenceArgumentEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getByValueArgument() {
		return byValueArgumentEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getByContentArgument() {
		return byContentArgumentEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getOmittedArgument() {
		return omittedArgumentEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getArgumentable_Returning() {
		return (EReference)argumentableEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(argumentEClass, ARGUMENT__OPERANDS);

		byReferenceArgumentEClass = createEClass(BY_REFERENCE_ARGUMENT);

		byValueArgumentEClass = createEClass(BY_VALUE_ARGUMENT);

		byContentArgumentEClass = createEClass(BY_CONTENT_ARGUMENT);

		omittedArgumentEClass = createEClass(OMITTED_ARGUMENT);

		argumentableEClass = createEClass(ARGUMENTABLE);
		createEReference(argumentableEClass, ARGUMENTABLE__ARGUMENTS);
		createEReference(argumentableEClass, ARGUMENTABLE__RETURNING);
	}
	...
	public void initializePackageContents() {
		...
		functionCallEClass.getESuperTypes().add(this.getArgumentable());
		functionCallEClass.getESuperTypes().add(theCommonsPackage.getNamedElement());
		functionCallEClass.getESuperTypes().add(theIdentifiersPackage.getIdentifier());
		byReferenceArgumentEClass.getESuperTypes().add(this.getArgument());
		byValueArgumentEClass.getESuperTypes().add(this.getArgument());
		byContentArgumentEClass.getESuperTypes().add(this.getArgument());
		omittedArgumentEClass.getESuperTypes().add(this.getArgument());

		// Initialize classes and features; add operations and parameters
		initEClass(functionCallEClass, FunctionCall.class, "FunctionCall", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(argumentEClass, Argument.class, "Argument", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getArgument_Operands(), theOperandsPackage.getPrimaryOperand(), null, "operands", null, 0, -1, Argument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(byReferenceArgumentEClass, ByReferenceArgument.class, "ByReferenceArgument", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(byValueArgumentEClass, ByValueArgument.class, "ByValueArgument", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(byContentArgumentEClass, ByContentArgument.class, "ByContentArgument", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(omittedArgumentEClass, OmittedArgument.class, "OmittedArgument", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(argumentableEClass, Argumentable.class, "Argumentable", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getArgumentable_Arguments(), this.getArgument(), null, "arguments", null, 0, -1, Argumentable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArgumentable_Returning(), this.getArgument(), null, "returning", null, 0, 1, Argumentable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
