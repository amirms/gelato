...
import org.servicifi.gelato.language.cobol.parameters.ParametersFactory;
...
public class ParametersPackageImpl extends EPackageImpl implements ParametersPackage {
	 ...
	 * @generated
	 */
	private EClass byReferenceParameterEClass = null;
	 ...
	 * @generated
	 */
	private EClass byValueParameterEClass = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.parameters.ParametersPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getParametrizable_Returning() {
		return (EReference)parametrizableEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getByReferenceParameter() {
		return byReferenceParameterEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getByValueParameter() {
		return byValueParameterEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(parametrizableEClass, PARAMETRIZABLE__RETURNING);

		parameterEClass = createEClass(PARAMETER);

		byReferenceParameterEClass = createEClass(BY_REFERENCE_PARAMETER);

		byValueParameterEClass = createEClass(BY_VALUE_PARAMETER);
	}
	...
	public void initializePackageContents() {
		...
		parameterEClass.getESuperTypes().add(theReferencesPackage.getReferenceableElement());
		byReferenceParameterEClass.getESuperTypes().add(this.getParameter());
		byValueParameterEClass.getESuperTypes().add(this.getParameter());
		...
		initEReference(getParametrizable_Returning(), this.getParameter(), null, "returning", null, 0, 1, Parametrizable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(parameterEClass, Parameter.class, "Parameter", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(byReferenceParameterEClass, ByReferenceParameter.class, "ByReferenceParameter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(byValueParameterEClass, ByValueParameter.class, "ByValueParameter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}
