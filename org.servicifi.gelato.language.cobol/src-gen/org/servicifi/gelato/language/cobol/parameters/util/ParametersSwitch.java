...
public class ParametersSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ParametersPackage.BY_REFERENCE_PARAMETER: {
				ByReferenceParameter byReferenceParameter = (ByReferenceParameter)theEObject;
				T result = caseByReferenceParameter(byReferenceParameter);
				if (result == null) result = caseParameter(byReferenceParameter);
				if (result == null) result = caseReferenceableElement(byReferenceParameter);
				if (result == null) result = caseNamedElement(byReferenceParameter);
				if (result == null) result = caseCommentable(byReferenceParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParametersPackage.BY_VALUE_PARAMETER: {
				ByValueParameter byValueParameter = (ByValueParameter)theEObject;
				T result = caseByValueParameter(byValueParameter);
				if (result == null) result = caseParameter(byValueParameter);
				if (result == null) result = caseReferenceableElement(byValueParameter);
				if (result == null) result = caseNamedElement(byValueParameter);
				if (result == null) result = caseCommentable(byValueParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>By Reference Parameter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>By Reference Parameter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseByReferenceParameter(ByReferenceParameter object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>By Value Parameter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>By Value Parameter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseByValueParameter(ByValueParameter object) {
		return null;
	}
