...
public class FilesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FilesPackage.FILE_NAME: {
				FileName fileName = (FileName)theEObject;
				T result = caseFileName(fileName);
				if (result == null) result = caseIncompleteElement(fileName);
				if (result == null) result = caseReferenceableElement(fileName);
				if (result == null) result = caseNamedElement(fileName);
				if (result == null) result = caseCommentable(fileName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FilesPackage.SELECT_STATEMENT: {
				SelectStatement selectStatement = (SelectStatement)theEObject;
				T result = caseSelectStatement(selectStatement);
				if (result == null) result = caseIncompleteElement(selectStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FilesPackage.FILE_STATUS: {
				FileStatus fileStatus = (FileStatus)theEObject;
				T result = caseFileStatus(fileStatus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>File Status</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>File Status</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFileStatus(FileStatus object) {
		return null;
	}
