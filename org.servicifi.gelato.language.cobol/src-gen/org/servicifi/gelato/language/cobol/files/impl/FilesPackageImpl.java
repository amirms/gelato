...
import org.servicifi.gelato.language.cobol.files.FilesFactory;
...
public class FilesPackageImpl extends EPackageImpl implements FilesPackage {
	 ...
	 * @generated
	 */
	private EClass fileStatusEClass = null;
	 ...
	 * @generated
	 */
	private EEnum fileDescriptorsEEnum = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.files.FilesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getFileName_FileDescriptor() {
	 ...
	 * @generated
	 */
	public EReference getFileName_Records() {
	 ...
	 * @generated
	 */
	public EReference getFileName_Attributes() {
	 ...
	 * @generated
	 */
	public EReference getFileName_Sentences() {
		return (EReference)fileNameEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getSelectStatement_FileStatus() {
	 ...
	 * @generated
	 */
	public EAttribute getSelectStatement_IsOptional() {
		return (EAttribute)selectStatementEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSelectStatement_ExternalFileNames() {
		return (EAttribute)selectStatementEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getSelectStatement_FileNameReference() {
	 ...
	 * @generated
	 */
	public EClass getFileStatus() {
		return fileStatusEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getFileStatus_FileStatus() {
		return (EReference)fileStatusEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getFileStatus_VsamFileStatus() {
		return (EReference)fileStatusEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EEnum getFileDescriptors() {
		return fileDescriptorsEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(fileNameEClass, FILE_NAME__FILE_DESCRIPTOR);
		createEReference(fileNameEClass, FILE_NAME__RECORDS);
		createEReference(fileNameEClass, FILE_NAME__ATTRIBUTES);
		createEReference(fileNameEClass, FILE_NAME__SENTENCES);

		selectStatementEClass = createEClass(SELECT_STATEMENT);
		createEReference(selectStatementEClass, SELECT_STATEMENT__FILE_STATUS);
		createEAttribute(selectStatementEClass, SELECT_STATEMENT__IS_OPTIONAL);
		createEAttribute(selectStatementEClass, SELECT_STATEMENT__EXTERNAL_FILE_NAMES);
		createEReference(selectStatementEClass, SELECT_STATEMENT__FILE_NAME_REFERENCE);

		fileStatusEClass = createEClass(FILE_STATUS);
		createEReference(fileStatusEClass, FILE_STATUS__FILE_STATUS);
		createEReference(fileStatusEClass, FILE_STATUS__VSAM_FILE_STATUS);

		// Create enums
		fileDescriptorsEEnum = createEEnum(FILE_DESCRIPTORS);
	}
	...
	public void initializePackageContents() {
		...
		fileNameEClass.getESuperTypes().add(theWaterPackage.getIncompleteElement());
		fileNameEClass.getESuperTypes().add(theReferencesPackage.getReferenceableElement());
		selectStatementEClass.getESuperTypes().add(theWaterPackage.getIncompleteElement());

		// Initialize classes and features; add operations and parameters
		initEClass(fileNameEClass, FileName.class, "FileName", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFileName_FileDescriptor(), this.getFileDescriptors(), "fileDescriptor", null, 1, 1, FileName.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFileName_Records(), theDataitemsPackage.getDataItem(), null, "records", null, 0, -1, FileName.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFileName_Attributes(), theDataitemsPackage.getDataItemAttribute(), null, "attributes", null, 0, -1, FileName.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFileName_Sentences(), theSentencesPackage.getStatementContainer(), null, "sentences", null, 0, -1, FileName.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSelectStatement_FileStatus(), this.getFileStatus(), null, "fileStatus", null, 0, 1, SelectStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectStatement_IsOptional(), ecorePackage.getEBoolean(), "isOptional", null, 1, 1, SelectStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectStatement_ExternalFileNames(), ecorePackage.getEString(), "externalFileNames", null, 1, -1, SelectStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSelectStatement_FileNameReference(), theReferencesPackage.getFileNameReference(), null, "fileNameReference", null, 1, 1, SelectStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(fileStatusEClass, FileStatus.class, "FileStatus", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFileStatus_FileStatus(), theIdentifiersPackage.getIdentifierReference(), null, "fileStatus", null, 1, 1, FileStatus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFileStatus_VsamFileStatus(), theIdentifiersPackage.getIdentifierReference(), null, "vsamFileStatus", null, 0, 1, FileStatus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(fileDescriptorsEEnum, FileDescriptors.class, "FileDescriptors");
		addEEnumLiteral(fileDescriptorsEEnum, FileDescriptors.FD);
		addEEnumLiteral(fileDescriptorsEEnum, FileDescriptors.SD);
	}
