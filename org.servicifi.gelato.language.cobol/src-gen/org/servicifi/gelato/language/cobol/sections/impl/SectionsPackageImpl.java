...
import org.servicifi.gelato.language.cobol.sections.SectionsFactory;
 ...
 * @generated
 */
public class SectionsPackageImpl extends EPackageImpl implements SectionsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass localStorageSectionEClass = null;
	 ...
	 * @generated
	 */
	private EClass linkageStorageSectionEClass = null;
	 ...
	 * @generated
	 */
	private EClass ioSectionEClass = null;
	 ...
	 * @generated
	 */
	private EClass configurationSectionEClass = null;
	 ...
	 * @generated
	 */
	private EClass environmentDivisionSectionEClass = null;
	 ...
	 * @generated
	 */
	private EClass dataDivisionSectionEClass = null;
	 ...
	 * @generated
	 */
	private EClass declarativeSectionEClass = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.sections.SectionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SectionsPackageImpl() {
		super(eNS_URI, SectionsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link SectionsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SectionsPackage init() {
		if (isInited) return (SectionsPackage)EPackage.Registry.INSTANCE.getEPackage(SectionsPackage.eNS_URI);

		// Obtain or create and register package
		SectionsPackageImpl theSectionsPackage = (SectionsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SectionsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SectionsPackageImpl());
		...
		theSectionsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SectionsPackage.eNS_URI, theSectionsPackage);
		return theSectionsPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSection_SegmentNumber() {
	...
	public EClass getLocalStorageSection() {
		return localStorageSectionEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getLinkageStorageSection() {
		return linkageStorageSectionEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getIOSection() {
		return ioSectionEClass;
	}
	...
	public EClass getConfigurationSection() {
		return configurationSectionEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getEnvironmentDivisionSection() {
		return environmentDivisionSectionEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getDataDivisionSection() {
		return dataDivisionSectionEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getDataDivisionSection_Statements() {
		return (EReference)dataDivisionSectionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getDataDivisionSection_Records() {
		return (EReference)dataDivisionSectionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFileSection_FileDescriptors() {
	 ...
	 * @generated
	 */
	public EClass getDeclarativeSection() {
		return declarativeSectionEClass;
	}
	 ...
	 * @generated
	 */
	public SectionsFactory getSectionsFactory() {
		return (SectionsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(sectionEClass, SECTION__SENTENCES);
		createEReference(sectionEClass, SECTION__PARAGRAPHS);
		createEAttribute(sectionEClass, SECTION__SEGMENT_NUMBER);

		workingStorageSectionEClass = createEClass(WORKING_STORAGE_SECTION);

		localStorageSectionEClass = createEClass(LOCAL_STORAGE_SECTION);

		linkageStorageSectionEClass = createEClass(LINKAGE_STORAGE_SECTION);

		ioSectionEClass = createEClass(IO_SECTION);

		configurationSectionEClass = createEClass(CONFIGURATION_SECTION);

		environmentDivisionSectionEClass = createEClass(ENVIRONMENT_DIVISION_SECTION);

		dataDivisionSectionEClass = createEClass(DATA_DIVISION_SECTION);
		createEReference(dataDivisionSectionEClass, DATA_DIVISION_SECTION__STATEMENTS);
		createEReference(dataDivisionSectionEClass, DATA_DIVISION_SECTION__RECORDS);

		fileSectionEClass = createEClass(FILE_SECTION);
		createEReference(fileSectionEClass, FILE_SECTION__FILE_DESCRIPTORS);

		declarativeSectionEClass = createEClass(DECLARATIVE_SECTION);
	}
