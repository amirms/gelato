...
public class CommonsAdapterFactory extends AdapterFactoryImpl {
	...
	protected CommonsSwitch<Adapter> modelSwitch =
		new CommonsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseURIableElement(URIableElement object) {
				return createURIableElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.commons.LabellableElement <em>Labellable Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.servicifi.gelato.language.cobol.commons.URIableElement <em>UR Iable Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createURIableElementAdapter() {
		return null;
	}
