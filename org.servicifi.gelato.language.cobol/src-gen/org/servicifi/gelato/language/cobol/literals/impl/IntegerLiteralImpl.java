 ...
 * <ul>
 *   <li>{@link org.servicifi.gelato.language.cobol.literals.impl.IntegerLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerLiteralImpl extends NumericLiteralImpl implements IntegerLiteral {
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LiteralsPackage.INTEGER_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LiteralsPackage.INTEGER_LITERAL__VALUE:
				return getValue();
		}
