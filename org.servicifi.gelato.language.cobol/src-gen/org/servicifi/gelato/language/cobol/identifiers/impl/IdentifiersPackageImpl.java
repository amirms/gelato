...
import org.servicifi.gelato.language.cobol.identifiers.IdentifiersFactory;
 ...
 * @generated
 */
public class IdentifiersPackageImpl extends EPackageImpl implements IdentifiersPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass referenceModifierEClass = null;
	 ...
	 * @generated
	 */
	private EClass linageCounterEClass = null;
	 ...
	 * @generated
	 */
	private EClass relativeSubscriptEClass = null;
	 ...
	 * @generated
	 */
	private EClass directSubscriptEClass = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.identifiers.IdentifiersPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IdentifiersPackageImpl() {
		super(eNS_URI, IdentifiersFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link IdentifiersPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static IdentifiersPackage init() {
		if (isInited) return (IdentifiersPackage)EPackage.Registry.INSTANCE.getEPackage(IdentifiersPackage.eNS_URI);

		// Obtain or create and register package
		IdentifiersPackageImpl theIdentifiersPackage = (IdentifiersPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof IdentifiersPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new IdentifiersPackageImpl());
		...
		theIdentifiersPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IdentifiersPackage.eNS_URI, theIdentifiersPackage);
		return theIdentifiersPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getSubscript_Subscript() {
	 ...
	 * @generated
	 */
	public EReference getIdentifier_Modifier() {
	 ...
	 * @generated
	 */
	public EReference getIdentifierReference_Subscripts() {
		return (EReference)identifierReferenceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getIdentifierReference_Qualifiers() {
		return (EReference)identifierReferenceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getReferenceModifier() {
		return referenceModifierEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getReferenceModifier_Start() {
		return (EReference)referenceModifierEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getReferenceModifier_Length() {
		return (EReference)referenceModifierEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getRelativeSubscript() {
		return relativeSubscriptEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getRelativeSubscript_AdditiveOperator() {
		return (EReference)relativeSubscriptEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRelativeSubscript_Integer() {
		return (EReference)relativeSubscriptEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getDirectSubscript() {
		return directSubscriptEClass;
	}
	 ...
	 * @generated
	 */
	public IdentifiersFactory getIdentifiersFactory() {
		return (IdentifiersFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(subscriptEClass, SUBSCRIPT__SUBSCRIPT);

		identifierEClass = createEClass(IDENTIFIER);
		createEReference(identifierEClass, IDENTIFIER__MODIFIER);

		identifierReferenceEClass = createEClass(IDENTIFIER_REFERENCE);
		createEReference(identifierReferenceEClass, IDENTIFIER_REFERENCE__SUBSCRIPTS);
		createEReference(identifierReferenceEClass, IDENTIFIER_REFERENCE__QUALIFIERS);

		allEClass = createEClass(ALL);

		referenceModifierEClass = createEClass(REFERENCE_MODIFIER);
		createEReference(referenceModifierEClass, REFERENCE_MODIFIER__START);
		createEReference(referenceModifierEClass, REFERENCE_MODIFIER__LENGTH);

		linageCounterEClass = createEClass(LINAGE_COUNTER);

		qualifierEClass = createEClass(QUALIFIER);

		relativeSubscriptEClass = createEClass(RELATIVE_SUBSCRIPT);
		createEReference(relativeSubscriptEClass, RELATIVE_SUBSCRIPT__ADDITIVE_OPERATOR);
		createEReference(relativeSubscriptEClass, RELATIVE_SUBSCRIPT__INTEGER);

		directSubscriptEClass = createEClass(DIRECT_SUBSCRIPT);
	}
	...
	public void initializePackageContents() {
		...
		identifierEClass.getESuperTypes().add(theOperandsPackage.getPrimaryOperand());
		identifierEClass.getESuperTypes().add(theWaterPackage.getAcceptStatementWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getCICSStatementWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getSpecialNamesParagraphWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getObjectComputerParagraphWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getRepositoryParagraphWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getIOControlParagraphWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getIdentificationDivisionWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getInvokeStatementWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getSQLStatementWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getUseStatementWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getFileDescriptorWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getDataDescriptorWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getSelectStatementWater());
		identifierEClass.getESuperTypes().add(theWaterPackage.getSortPhraseWater());
		identifierReferenceEClass.getESuperTypes().add(this.getIdentifier());
		identifierReferenceEClass.getESuperTypes().add(theReferencesPackage.getElementReference());
		identifierReferenceEClass.getESuperTypes().add(theReferencesPackage.getQualifiable());
		allEClass.getESuperTypes().add(this.getDirectSubscript());
		linageCounterEClass.getESuperTypes().add(this.getIdentifier());
		linageCounterEClass.getESuperTypes().add(theReferencesPackage.getQualifiable());
		qualifierEClass.getESuperTypes().add(theReferencesPackage.getElementReference());
		relativeSubscriptEClass.getESuperTypes().add(this.getSubscript());
		directSubscriptEClass.getESuperTypes().add(this.getSubscript());

		// Initialize classes and features; add operations and parameters
		initEClass(subscriptEClass, Subscript.class, "Subscript", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSubscript_Subscript(), theOperandsPackage.getOperand(), null, "subscript", null, 1, 1, Subscript.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(identifierEClass, Identifier.class, "Identifier", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIdentifier_Modifier(), this.getReferenceModifier(), null, "modifier", null, 0, 1, Identifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIdentifierReference_Subscripts(), this.getSubscript(), null, "subscripts", null, 0, -1, IdentifierReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIdentifierReference_Qualifiers(), this.getQualifier(), null, "qualifiers", null, 0, -1, IdentifierReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(allEClass, All.class, "All", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(referenceModifierEClass, ReferenceModifier.class, "ReferenceModifier", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceModifier_Start(), theArithmeticsPackage.getArithmeticExpression(), null, "start", null, 1, 1, ReferenceModifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getReferenceModifier_Length(), theArithmeticsPackage.getArithmeticExpression(), null, "length", null, 0, 1, ReferenceModifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(linageCounterEClass, LinageCounter.class, "LinageCounter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(qualifierEClass, Qualifier.class, "Qualifier", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(relativeSubscriptEClass, RelativeSubscript.class, "RelativeSubscript", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRelativeSubscript_AdditiveOperator(), theOperatorsPackage.getAdditiveOperator(), null, "additiveOperator", null, 1, 1, RelativeSubscript.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelativeSubscript_Integer(), theLiteralsPackage.getIntegerLiteral(), null, "integer", null, 1, 1, RelativeSubscript.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(directSubscriptEClass, DirectSubscript.class, "DirectSubscript", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //IdentifiersPackageImpl
