 ...
 * </p>
 * <ul>
 *   <li>{@link org.servicifi.gelato.language.cobol.operators.impl.GreaterThanOrEqualImpl#isThan <em>Than</em>}</li>
 *   <li>{@link org.servicifi.gelato.language.cobol.operators.impl.GreaterThanOrEqualImpl#isTo <em>To</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GreaterThanOrEqualImpl extends RelationalOperatorImpl implements GreaterThanOrEqual {
	/**
	...
	public void setThan(boolean newThan) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorsPackage.GREATER_THAN_OR_EQUAL__THAN, oldThan, than));
	}
	...
	public void setTo(boolean newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorsPackage.GREATER_THAN_OR_EQUAL__TO, oldTo, to));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperatorsPackage.GREATER_THAN_OR_EQUAL__THAN:
				return isThan();
			case OperatorsPackage.GREATER_THAN_OR_EQUAL__TO:
				return isTo();
		}
