 ...
 * <ul>
 *   <li>{@link org.servicifi.gelato.language.cobol.operators.impl.LessThanImpl#isThan <em>Than</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class LessThanImpl extends RelationalOperatorImpl implements LessThan {
	/**
	...
	protected EClass eStaticClass() {
		return OperatorsPackage.Literals.LESS_THAN;
	}
	...
	public void setThan(boolean newThan) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorsPackage.LESS_THAN__THAN, oldThan, than));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperatorsPackage.LESS_THAN__THAN:
				return isThan();
		}
