...
import org.servicifi.gelato.language.cobol.tables.TablesFactory;
...
public class TablesPackageImpl extends EPackageImpl implements TablesPackage {
	 ...
	 * @generated
	 */
	private EClass keyNameEClass = null;
	 ...
	 * @generated
	 */
	private EClass indexNameEClass = null;
	 ...
	 * @generated
	 */
	private EClass tableDimensionEClass = null;
	 ...
	 * @generated
	 */
	private EClass additionalIndexNameEClass = null;
	 ...
	 * @see org.servicifi.gelato.language.cobol.tables.TablesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static TablesPackage init() {
		...
		TablesPackageImpl theTablesPackage = (TablesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TablesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TablesPackageImpl());
	 ...
	 * @generated
	 */
	public EReference getTable_TableDimension() {
	 ...
	 * @generated
	 */
	public EReference getTable_IndexedBy() {
	 ...
	 * @generated
	 */
	public EReference getTable_KeysAre() {
	 ...
	 * @generated
	 */
	public EReference getTable_MaxTableDimension() {
	 ...
	 * @generated
	 */
	public EReference getTable_DependsOn() {
	 ...
	 * @generated
	 */
	public EClass getKeyName() {
		return keyNameEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getKeyName_Keys() {
		return (EReference)keyNameEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getKeyName_KeyOrder() {
		return (EAttribute)keyNameEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getIndexName() {
		return indexNameEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIndexName_AdditionalIndexNames() {
		return (EReference)indexNameEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getTableDimension() {
		return tableDimensionEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTableDimension_Value() {
		return (EAttribute)tableDimensionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getAdditionalIndexName() {
		return additionalIndexNameEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(tableEClass, TABLE__TABLE_DIMENSION);
		createEReference(tableEClass, TABLE__INDEXED_BY);
		createEReference(tableEClass, TABLE__KEYS_ARE);
		createEReference(tableEClass, TABLE__MAX_TABLE_DIMENSION);
		createEReference(tableEClass, TABLE__DEPENDS_ON);

		keyNameEClass = createEClass(KEY_NAME);
		createEReference(keyNameEClass, KEY_NAME__KEYS);
		createEAttribute(keyNameEClass, KEY_NAME__KEY_ORDER);

		indexNameEClass = createEClass(INDEX_NAME);
		createEReference(indexNameEClass, INDEX_NAME__ADDITIONAL_INDEX_NAMES);

		tableDimensionEClass = createEClass(TABLE_DIMENSION);
		createEAttribute(tableDimensionEClass, TABLE_DIMENSION__VALUE);

		additionalIndexNameEClass = createEClass(ADDITIONAL_INDEX_NAME);
	...
	public void initializePackageContents() {
		...
		tableEClass.getESuperTypes().add(theDataitemsPackage.getDataItem());
		tableEClass.getESuperTypes().add(theWaterPackage.getIncompleteElement());
		indexNameEClass.getESuperTypes().add(theCommonsPackage.getNamedElement());
		indexNameEClass.getESuperTypes().add(theReferencesPackage.getReferenceableElement());
		additionalIndexNameEClass.getESuperTypes().add(theReferencesPackage.getReferenceableElement());

		// Initialize classes and features; add operations and parameters
		initEClass(tableEClass, Table.class, "Table", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTable_TableDimension(), this.getTableDimension(), null, "tableDimension", null, 1, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTable_IndexedBy(), this.getIndexName(), null, "indexedBy", null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTable_KeysAre(), this.getKeyName(), null, "keysAre", null, 0, -1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTable_MaxTableDimension(), this.getTableDimension(), null, "maxTableDimension", null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTable_DependsOn(), theIdentifiersPackage.getIdentifierReference(), null, "dependsOn", null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(keyNameEClass, KeyName.class, "KeyName", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getKeyName_Keys(), theIdentifiersPackage.getIdentifierReference(), null, "keys", null, 1, -1, KeyName.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getKeyName_KeyOrder(), this.getSortingOrder(), "keyOrder", null, 1, 1, KeyName.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(indexNameEClass, IndexName.class, "IndexName", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIndexName_AdditionalIndexNames(), this.getAdditionalIndexName(), null, "additionalIndexNames", null, 0, -1, IndexName.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tableDimensionEClass, TableDimension.class, "TableDimension", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTableDimension_Value(), ecorePackage.getEInt(), "value", null, 1, 1, TableDimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(additionalIndexNameEClass, AdditionalIndexName.class, "AdditionalIndexName", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		// Initialize enums and add enum literals
		initEEnum(sortingOrderEEnum, SortingOrder.class, "SortingOrder");
		addEEnumLiteral(sortingOrderEEnum, SortingOrder.ASC);
		addEEnumLiteral(sortingOrderEEnum, SortingOrder.DSC);
	}
