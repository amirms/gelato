 ...
 * @generated
 */
public class CloseImpl extends IncompleteElementImpl implements Close {
	/**
	...
	protected EClass eStaticClass() {
		return StatementsPackage.Literals.CLOSE;
	}
		...
		if (next != null && next.eIsProxy()) {
			...
			if (next != oldNext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StatementsPackage.CLOSE__NEXT, oldNext, next));
			}
		}
		return next;
	}
	...
	public void setNext(Statement newNext) {
		...
		next = newNext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatementsPackage.CLOSE__NEXT, oldNext, next));
	}
	...
	public void setEndVerb(boolean newEndVerb) {
		...
		endVerb = newEndVerb;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatementsPackage.CLOSE__END_VERB, oldEndVerb, endVerb));
	}
	...
	public EList<IOFileDescriptor> getIoFileDescriptors() {
		if (ioFileDescriptors == null) {
			ioFileDescriptors = new EObjectContainmentEList<IOFileDescriptor>(IOFileDescriptor.class, this, StatementsPackage.CLOSE__IO_FILE_DESCRIPTORS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatementsPackage.CLOSE__IO_FILE_DESCRIPTORS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatementsPackage.CLOSE__NEXT:
				if (resolve) return getNext();
				return basicGetNext();
			case StatementsPackage.CLOSE__END_VERB:
				return isEndVerb();
			case StatementsPackage.CLOSE__IO_FILE_DESCRIPTORS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Statement.class) {
			switch (derivedFeatureID) {
				case StatementsPackage.CLOSE__NEXT: return StatementsPackage.STATEMENT__NEXT;
				case StatementsPackage.CLOSE__END_VERB: return StatementsPackage.STATEMENT__END_VERB;
				default: return -1;
			}
		}
		if (baseClass == IOStatement.class) {
			switch (derivedFeatureID) {
				case StatementsPackage.CLOSE__IO_FILE_DESCRIPTORS: return StatementsPackage.IO_STATEMENT__IO_FILE_DESCRIPTORS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Statement.class) {
			switch (baseFeatureID) {
				case StatementsPackage.STATEMENT__NEXT: return StatementsPackage.CLOSE__NEXT;
				case StatementsPackage.STATEMENT__END_VERB: return StatementsPackage.CLOSE__END_VERB;
				default: return -1;
			}
		}
		if (baseClass == IOStatement.class) {
			switch (baseFeatureID) {
				case StatementsPackage.IO_STATEMENT__IO_FILE_DESCRIPTORS: return StatementsPackage.CLOSE__IO_FILE_DESCRIPTORS;
				default: return -1;
			}
		}
