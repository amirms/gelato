 ...
 * </p>
 * <ul>
 *   <li>{@link org.servicifi.gelato.language.cobol.paragraphs.impl.ParagraphImpl#getSentences <em>Sentences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphImpl extends NamedElementImpl implements Paragraph {
	/**
	...
	protected EClass eStaticClass() {
		return ParagraphsPackage.Literals.PARAGRAPH;
	}
	...
	public EList<StatementContainer> getSentences() {
		if (sentences == null) {
			sentences = new EObjectContainmentEList<StatementContainer>(StatementContainer.class, this, ParagraphsPackage.PARAGRAPH__SENTENCES);
		}
		return sentences;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ParagraphsPackage.PARAGRAPH__SENTENCES:
