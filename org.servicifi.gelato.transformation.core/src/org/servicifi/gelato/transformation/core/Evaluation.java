...
public class Evaluation {
	...
	public static void main(String[] args) {
		...
		try {
			String[] projects = new String[] { "caro" };

			for (String projectName : projects) {
				File file = new File(
						"C:\\Users\\AmirM\\Documents\\workspace\\eclipse\\org.servicifi.gelato.transformation.core\\input\\"
								+ projectName);
				...
				eva.run("c2k.qvto",
						"C:\\Users\\AmirM\\Documents\\workspace\\eclipse\\org.servicifi.gelato.transformation.core\\input",
						projectName, files, collector);
				String transformedFile = "C:\\Users\\AmirM\\Documents\\workspace\\eclipse\\org.servicifi.gelato.transformation.core\\output_qvto\\"
						+ projectName + "\\" + files.get(0).getName().substring(0, files.get(0).getName().indexOf('.'))
						+ "_transformed.kernel";

				KernelSourceFileLoader loader = new KernelSourceFileLoader(transformedFile);
