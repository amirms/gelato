...
public class CobolUniquePathConstructor {
	 ...
	 * Pathmap (URI scheme + first segment) for Cobol copybooks.
	 */
	public static final String EXPANDED_COBOL_COPYBOOK_PATHMAP    = "pathmap:/expandedcobolcopybooks/";
	...
	public static URI getCobolCompilationUnitURI(String fullQualifiedName) {
		...
		URI logicalUri = getCopybookFileResourceURI(fullQualifiedName);
	 ...
	 * @return the logical URI for the classifier
	 */
	public static URI getCopybookFileResourceURI(String fullName) {
	...
	/**
	 * Constructs an URI for an expanded copybook inside the EMF-model 
	 * constructed  from that resource.
	 *
	 * @param fullName
	 * @return the logical URI for the classifier
	 */
	public static URI getExpandedCopybookResourceURI(String fullName) {
		StringBuilder logicalUriString = new StringBuilder(EXPANDED_COBOL_COPYBOOK_PATHMAP);
		logicalUriString.append(fullName);
		logicalUriString.append(COBOL_COPYBOOK_FILE_EXTENSION);
	...
	public static URI getCopybookResourceURI(String fullQualifiedName) {
