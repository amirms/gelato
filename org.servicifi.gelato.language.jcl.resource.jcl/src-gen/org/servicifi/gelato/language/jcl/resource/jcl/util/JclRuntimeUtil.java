...
public class JclRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
