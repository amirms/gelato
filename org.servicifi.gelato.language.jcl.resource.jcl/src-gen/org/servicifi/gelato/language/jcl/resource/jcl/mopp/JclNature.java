...
public class JclNature implements IProjectNature {
	
	public static final String NATURE_ID = "org.servicifi.gelato.language.jcl.resource.jcl.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
