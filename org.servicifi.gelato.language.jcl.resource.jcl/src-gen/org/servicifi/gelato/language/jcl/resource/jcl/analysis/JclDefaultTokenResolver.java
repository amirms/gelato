 ...
 * </p>
 */
public class JclDefaultTokenResolver implements org.servicifi.gelato.language.jcl.resource.jcl.IJclTokenResolver {
	 ...
	 */
	public JclDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public JclDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, org.servicifi.gelato.language.jcl.resource.jcl.IJclTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclGrammarInformationProvider.INSTANCE.getKeywords()) {
