...
public class JclCopiedEObjectInternalEList extends org.servicifi.gelato.language.jcl.resource.jcl.util.JclCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public JclCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
