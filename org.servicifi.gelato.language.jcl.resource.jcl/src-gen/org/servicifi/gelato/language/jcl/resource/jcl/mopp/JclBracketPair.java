 ...
 */
public class JclBracketPair implements org.servicifi.gelato.language.jcl.resource.jcl.IJclBracketPair {
	...
	public JclBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;
