...
public abstract class JclQuickFix implements org.servicifi.gelato.language.jcl.resource.jcl.IJclQuickFix {
	...
	public JclQuickFix(String displayString, String imageKey, EObject contextObject) {
		this(displayString, imageKey, Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public JclQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public JclQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects, Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new org.servicifi.gelato.language.jcl.resource.jcl.util.JclRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
