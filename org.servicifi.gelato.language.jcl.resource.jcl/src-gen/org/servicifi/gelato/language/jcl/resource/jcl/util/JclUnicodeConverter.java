 ...
 * to 4 bytes).
 */
public class JclUnicodeConverter extends org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclInputStreamProcessor {
	 ...
	 */
	public JclUnicodeConverter(InputStream inputStream) {
