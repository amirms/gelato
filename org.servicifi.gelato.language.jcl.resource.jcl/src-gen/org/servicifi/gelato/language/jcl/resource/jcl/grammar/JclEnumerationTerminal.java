 ...
 */
public class JclEnumerationTerminal extends org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclTerminal {
	
	private Map<String, String> mapping = new LinkedHashMap<String, String>();
	
	public JclEnumerationTerminal(EStructuralFeature attribute, String[] literalMappings, org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclCardinality cardinality, int mandatoryOccurrencesAfter) {
