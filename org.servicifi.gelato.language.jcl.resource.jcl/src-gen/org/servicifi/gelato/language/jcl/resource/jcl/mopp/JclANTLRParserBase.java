...
public abstract class JclANTLRParserBase extends Parser implements org.servicifi.gelato.language.jcl.resource.jcl.IJclTextParser {
	 ...
	 * result object.
	 */
	protected Collection<org.servicifi.gelato.language.jcl.resource.jcl.IJclCommand<org.servicifi.gelato.language.jcl.resource.jcl.IJclTextResource>> postParseCommands;
	 ...
	 */
	private org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclTokenResolveResult tokenResolveResult = new org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclTokenResolveResult();
	...
	public JclANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public JclANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclPlaceholder;
		isElementToStore |= syntaxElement instanceof org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclKeyword;
		isElementToStore |= syntaxElement instanceof org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof org.servicifi.gelato.language.jcl.resource.jcl.grammar.JclBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclLayoutInformationAdapter layoutInformationAdapter = getLayoutInformationAdapter(element);
		...
		layoutInformationAdapter.addLayoutInformation(new org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends EObject, ReferenceType extends EObject> void registerContextDependentProxy(final org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final EReference reference, final String id, final EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = org.servicifi.gelato.language.jcl.resource.jcl.util.JclMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclDummyEObject);
			org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclDummyEObject dummy = (org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclDummyEObject) object;
	...
	protected org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclTokenResolveResult getFreshTokenResolveResult() {
	...
	protected org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclReferenceResolverSwitch getReferenceResolverSwitch() {
		org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclReferenceResolverSwitch resolverSwitch = (org.servicifi.gelato.language.jcl.resource.jcl.mopp.JclReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(org.servicifi.gelato.language.jcl.resource.jcl.IJclOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(org.servicifi.gelato.language.jcl.resource.jcl.IJclOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}
